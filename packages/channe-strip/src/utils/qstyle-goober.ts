...
const core = {
  ...
  px: (padding: number) => ({
    paddingLeft: npx4(padding),
    paddingRight: npx4(padding),
  }),
  py: (padding: number) => ({
    paddingTop: npx4(padding),
    paddingBottom: npx4(padding),
  }),
  m: (margin: number) => ({ margin: npx4(margin) }),
  ml: (margin: number) => ({ marginLeft: npx4(margin) }),
  mr: (margin: number) => ({ marginRight: npx4(margin) }),
  mt: (margin: number) => ({ marginTop: npx4(margin) }),
  mb: (margin: number) => ({ marginBottom: npx4(margin) }),
  mx: (margin: number) => ({
    marginLeft: npx4(margin),
    marginRight: npx4(margin),
  }),
  my: (margin: number) => ({
    marginTop: npx4(margin),
    marginBottom: npx4(margin),
  }),
