(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(){let e=window;return e.__aluminaGlobal||={rerender:()=>{},asyncRerenderFlag:!1,hookEffectFuncs:[],debug:{nAll:0,nUpdated:0,nPatchCall:0},prevRootVdom:void 0,jsxCreateElementFunction:void 0,asyncLoopInitialized:!1,gHookInstance:void 0,gSheet:void 0,cssTextToClassNameMap:{},seqClassNameIndex:0,classNameIndexTable:{},cssClassNameToTextMap:{}},e.__aluminaGlobal}var t=e();function n(e){let t=e;return{get value(){return t},Provider:({value:e,children:n})=>(t=e,n[0])}}function r(e){return e.value}var i=`http://www.w3.org/2000/svg`,a=[`value`,`selected`,`checked`],o=[`key`,`children`,`if`,`ref`,...a];function s(e,t,n){let r=n?.props||{},i=t.props,a=Object.keys(i).filter(e=>!o.includes(e)).filter(e=>i[e]!==r[e]);Object.keys(r).filter(e=>!o.includes(e)).filter(e=>i[e]===void 0).forEach(t=>{let n=r[t];t.startsWith(`on`)&&typeof n==`function`?e[t.toLocaleLowerCase()]=void 0:e.removeAttribute(t)}),a.forEach(n=>{let r=t.props[n];r===!1||r==null?e.removeAttribute(n):n.startsWith(`on`)&&typeof r==`function`?e[n.toLocaleLowerCase()]=r:e.setAttribute(n,r?.toString()||``)}),!n?.marker&&t.marker&&e.setAttribute(`data-fc`,t.marker)}function c(e){return e.replace(/[A-Z]/g,e=>`-`+e.charAt(0).toLowerCase())}function l(e){return Object.keys(e).map(t=>{let n=e[t];return`${c(t)}:${n};`}).join(` `)}function u(e,n){if(typeof n==`string`&&e){for(let n in e)if(n.startsWith(`on`)){let r=e[n];delete e[n];let i=n.toLowerCase();e[i]=r?(...e)=>{r?.(...e),t.rerender()}:void 0}if(e.class||e.className){let t=[...Array.isArray(e.class)?e.class:[e.class],e.className].filter(e=>!!e).join(` `);delete e.className,e.class=t}e.style&&typeof e.style==`object`&&(e.style=l(e.style))}}function d(){return{holders:[],index:0,pendingEffectHolders:[]}}function f(e,t){if(!e||!t)return!0;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!0;return!1}function p(){let e=t.gHookInstance;if(!e)throw Error(`hook functions called outside render context`);let n=e,r=n.holders[n.index],i=!1;return r||(r=n.holders[n.index]={},i=!0),n.index++,{holder:r,first:i}}function m(e){let{holder:t,first:n}=p();n&&(t.value=e,t.setValue=e=>{typeof e==`function`?t.value=e(t.value):t.value=e});let{value:r,setValue:i}=t;return[r,i]}function h(e){let[t]=m(`call`in e?e():e);return t}function g(e,n){let{holder:r}=p();f(r.deps,n)&&(r.effectFunc=e,r.deps=n,t.gHookInstance.pendingEffectHolders.push(r))}function _(){let{holder:e,first:t}=p();return t&&(e.refObject={current:void 0}),e.refObject}function v(e){e.index=0,t.gHookInstance=e}function y(){t.gHookInstance=void 0}function b(e,n=!1){(n?e.holders:e.pendingEffectHolders).forEach(e=>{if(e.cleanupFunc&&=(e.cleanupFunc(),void 0),e.effectFunc){let n=e.effectFunc();n&&typeof n==`function`&&(e.cleanupFunc=n),t.asyncRerenderFlag=!0,e.effectFunc=void 0}}),e.pendingEffectHolders=[]}var x=Promise.resolve();function ee(e){x.then(e)}function S(e){return Array.isArray(e)?e.filter(e=>!!e).join(` `):e}function C(e){let t=e.name;return{name:t,mount(n,r){return n.fcsig=t,n.hook=d(),n.renderWithHook=r=>{v(n.hook);let i=e(r);if(i&&(i.marker=`${t}`),r.class&&i&&(i.vtype===`vElement`||i.vtype===`vComponent`)){let e=S(r.class);i.props.class=i.props.class?`${i.props.class} ${e}`:e}return y(),ee(()=>b(n.hook)),i},n.renderWithHook(r)},update(e,t){return e.renderWithHook(t)},unmount(e){b(e.hook,!0)}}}function te(e){return e.__AluminaFunctionComponentWrapper||=C(e),e.__AluminaFunctionComponentWrapper}function w(e){return{vtype:`vBlank`,debugSig:`blank__${e}`}}function ne(e){return{vtype:`vText`,text:e,debugSig:`text__${e}`}}function re(e,t,n){return{vtype:`vElement`,tagName:e,props:t,children:n,debugSig:`${e}__${n.length}`}}function ie(e,t,n){return{vtype:`vComponent`,componentWrapper:e,props:t,children:n,debugSig:`${e.name}`,state:{}}}function ae(e){if(e.some(e=>Array.isArray(e))){let t=[];for(let n of e)Array.isArray(n)?t.push(...n):t.push(n);return t}return e}function oe(e){return(Array.isArray(e)?ae(e):[e]).map(e=>e==null||e===!1?w(e):typeof e==`string`||typeof e==`number`||typeof e==`boolean`?ne(e.toString()):e)}function se(e){return`children`in e?oe(e.children):[]}function ce(e,t){if(t&&`if`in t&&!t.if)return w(null);if(e===le)return{vtype:`vFragment`,children:se(t)};u(t,e),typeof e==`function`&&(e=te(e));let n=se(t);return t={...t,children:n},typeof e==`object`?ie(e,t,n):re(e,t,n)}function T(e,t,...n){return t||={},n.length>0?ce(e,{...t,children:n}):ce(e,t)}function le(){}function E(e){e||console.log(`assertion failed`)}function D(e,t,n=null){let r;if(t.vtype===`vBlank`)r=document.createComment(`NULL`),e.insertBefore(r,n);else if(t.vtype===`vText`)r=document.createTextNode(t.text),e.insertBefore(r,n);else if(t.vtype===`vElement`){r=t.tagName===`svg`||e instanceof SVGElement?document.createElementNS(i,t.tagName):document.createElement(t.tagName),s(r,t,void 0),t.children.forEach(e=>D(r,e));let o=t.props.ref;o&&typeof o==`object`&&(o.current=r),e.insertBefore(r,n),a.forEach(e=>{let n=t.props[e];n!==void 0&&(r[e]=n)})}else if(t.vtype===`vComponent`){t.state.componentState={};let i=t.componentWrapper.mount(t.state.componentState,t.props)||w(null);t.state.renderRes=i,r=D(e,i,n)}else if(t.vtype===`vFragment`)r=e,t.children.forEach(e=>D(r,e,n));else throw Error(`invalid vnode ${t}`);return t.dom=r,r}function O(e,t){if(t.vtype===`vBlank`)e.removeChild(t.dom);else if(t.vtype===`vText`)e.removeChild(t.dom);else if(t.vtype===`vElement`){let n=t.dom;t.children.forEach(e=>O(n,e)),e.removeChild(n)}else if(t.vtype===`vComponent`)O(e,t.state.renderRes),t.state.renderRes=void 0,t.componentWrapper.unmount(t.state.componentState);else if(t.vtype===`vFragment`){let e=t.dom;t.children.forEach(t=>O(e,t))}else throw Error(`invalid vnode ${t}`);t.dom=void 0}function ue(e,t,n){t.state.componentState=n.state.componentState;let r=n.state.renderRes,i=t.componentWrapper.update(t.state.componentState,t.props)||w(null);t.state.renderRes=i,k(e,i,r)}function de(e,t,n){if(t.length===n.length)for(let r=0;r<t.length;r++){let i=t[r],a=n[r];k(e,i,a)}else n.forEach(t=>O(e,t)),t.forEach(t=>D(e,t))}function k(e,t,n){if(E(e&&t&&n),E(n.dom),E(!Array.isArray(t)),t===n)t.dom=n.dom;else if(t.vtype===`vBlank`&&n.vtype===`vBlank`)t.dom=n.dom;else if(t.vtype===`vText`&&n.vtype===`vText`){let e=n.dom;t.text!==n.text&&(e.nodeValue=t.text),t.dom=e}else if(t.vtype===`vComponent`&&n.vtype===`vComponent`&&t.componentWrapper===n.componentWrapper)ue(e,t,n),t.dom=n.dom;else if(n.dom instanceof Element&&t.vtype===`vElement`&&n.vtype===`vElement`&&t.tagName===n.tagName){let e=n.dom;s(e,t,n),de(e,t.children,n.children),t.dom=e,a.forEach(r=>{let i=n.props[r],a=t.props[r];(a!==i||t.children.length!==n.children.length)&&(e[r]=a)})}else if(t.vtype===`vFragment`&&n.vtype===`vFragment`){let e=n.dom;de(e,t.children,n.children),t.dom=e}else if(t.vtype!==n.vtype||n.vtype===`vElement`&&t.vtype===`vElement`&&n.tagName!==t.tagName||n.vtype===`vComponent`&&t.vtype===`vComponent`&&t.componentWrapper!==n.componentWrapper){let r=n.dom?.nextSibling||null;n.vtype===`vFragment`&&(r=n.children[n.children.length-1].dom?.nextSibling||null),O(e,n),D(e,t,r)}else console.log(`invalid condition`)}function fe(e,n){let r=t.prevRootVdom;r?k(n,e,r):D(n,e),t.prevRootVdom=e}var pe=/(?:([A-Z0-9-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(})/gi,me=/\/\*[\s\S]*?\*\/|\s{2,}|\n/gm,he=e=>{let t=[{}],n;for(;n=pe.exec(e.replace(me,``));)n[4]&&t.shift(),n[3]?t.unshift(t[0][n[3]]=t[0][n[3]]||{}):n[4]||(t[0][n[1]]=n[2]);return t[0]},A=(e,t)=>{let n=``,r=``,i=``,a;for(let o in e){let s=e[o];if(typeof s==`object`)a=t?t.replace(/([^,])+/g,e=>o.replace(/([^,])+/g,t=>/&/g.test(t)?t.replace(/&/g,e):e?e+` `+t:t)):o,o[0]===`@`?o[1]===`f`?r+=A(s,o):r+=o+`{`+A(s,o[1]===`k`?``:t)+`}`:r+=A(s,a);else if(o[0]===`@`&&o[1]===`i`)n=o+` `+s+`;`;else{let e=A.p;i+=e?e(o.replace(/[A-Z]/g,`-$&`).toLowerCase(),s):o.replace(/[A-Z]/g,`-$&`).toLowerCase()+`:`+s+`;`}}return i[0]?(a=t?t+`{`+i+`}`:i,n+a+r):n+r},ge=(e,n)=>{let{classNameIndexTable:r}=t,i=r[e];return i===void 0&&(i=r[e]=t.seqClassNameIndex++),n?`cs${i}_${n}`:`cs${i}`};function _e(){let{gSheet:e}=t;return e||(e=document.createElement(`style`),e.innerHTML=` `,e.id=`alumina_css_in_js`,document.head.appendChild(e),t.gSheet=e),e.firstChild}function ve(e){let t=_e(),n=e.replace(/label:.+?;/g,``);t.data.includes(n)||(t.data+=n)}function ye(e){return e.match(/label: (.+);/)?.[1]}function be(e,n){let r=``,i=0,{cssClassNameToTextMap:a}=t;for(i=0;i<n.length;i++){r+=e[i];let t=n[i].toString();a[t]&&(t=a[t]),r+=t}return r+=e[i],r}function j(e,...n){let{cssTextToClassNameMap:r,cssClassNameToTextMap:i}=t,a=be(e,n);if(r[a])return r[a];let o=ge(a,ye(a));return ve(A(he(a),`.${o}`)),r[a]=o,i[o]=a,o}function xe(e){let{cssClassNameToTextMap:n}=t,r=n[e];r&&ve(A(he(r),``))}function Se(e){t.jsxCreateElementFunction=e}new Proxy({},{get:(e,n)=>(...e)=>{let r=j(...e);return e=>{let i=[r,e.className||``].join(` `),{jsxCreateElementFunction:a}=t;return a(n,{...e,className:i})}}});function M(e,t){return t&&(e.props.class?e.props.class+=` `+t:e.props.class=t),e}Se(T);function N(){t.asyncRerenderFlag=!0}function Ce(){if(!t.asyncLoopInitialized){let e=()=>{t.asyncRerenderFlag&&=(t.rerender(),!1),requestAnimationFrame(e)};e(),t.asyncLoopInitialized=!0}}function we(e,n){let r=()=>{fe(e(),n),t.hookEffectFuncs.forEach(e=>e()),t.hookEffectFuncs=[]};t.rerender=r,r(),Ce()}var P={versionCode:`v220907`,bottomNoteNumber:24,numKeys:85,activeKeyRangeUnitOffsetDefault:14,activeKeyRangeUnitSize:15,mainKeyUnitWidth:50,octaveSelectionKeyUnitOffsets:[0,7,14,21,28,35]},F={isJapaneseEnvironment:!1,isWebMidiSupported:!1,isMobile:!1,get isPc(){return!F.isMobile}};F.isMobile&&(P.activeKeyRangeUnitSize=10,P.mainKeyUnitWidth=75);var Te=[[`piano`,`Piano`,`ピアノ`],[`elepi`,`Electric Piano`,`エレピ`],[`celesta`,`Celesta`,`チェレスタ`],[`guitar`,`Guitar`,`ギター`],[`bell`,`Bell`,`ベル`],[`ocarina`,`Ocarina`,`オカリナ`],[`bass1`,`Bass1`,`ベース1`],[`bass2`,`Bass2`,`ベース2`],[`pluck1`,`Pluck1`,`プラック1`],[`pluck2`,`Pluck2`,`プラック2`],[`pluck3`,`Pluck3`,`プラック3`],[`pluck4`,`Pluck4`,`プラック4`],[`brass1`,`Brass1`,`ブラス1`],[`brass2`,`Brass2`,`ブラス2`],[`lead1`,`Lead1`,`リード1`],[`lead2`,`Lead2`,`リード2`],[`lead3`,`Lead3`,`リード3`],[`lead4`,`Lead4`,`リード4`],[`pad1`,`Pad1`,`パッド1`],[`pad2`,`Pad2`,`パッド2`],[`strings1`,`Strings1`,`ストリングス1`],[`strings2`,`Strings2`,`ストリングス2`],[`orchestra`,`Orchestra`,`オーケストラ`],[`nes`,`NES`,`ファミコン`]],Ee=Te.map(e=>e[0]);function De(e,t){let n=t===`ja`?2:1;return Te.find(t=>t[0]===e)?.[n]||`err`}function I(e,t){let n={x:e.clientX,y:e.clientY},r=e=>{let r={x:e.clientX,y:e.clientY},i={x:r.x-n.x,y:r.y-n.y};t.moveHandler?.(i,e),e.preventDefault()},i=()=>{window.removeEventListener(`pointermove`,r),window.removeEventListener(`pointerup`,i),t.upHandler?.()};window.addEventListener(`pointermove`,r),window.addEventListener(`pointerup`,i)}var Oe=e=>e.preventDefault();function ke(e){return t=>{e(t.currentTarget.value)}}function L(e,t){return e.length===4?`${e}${(t*15>>0).toString(16)}`:e.length===7?`${e}${(t*255>>0).toString(16).padStart(2,`0`)}`:e}function Ae(){let e=Date.now();return{next(){let t=Date.now(),n=t-e;return e=t,n}}}function je(e,t){let n;return(...r)=>{n&&=(clearTimeout(n),void 0),n=setTimeout(()=>e(...r),t)}}var R;(function(e){function t(e,t,n){return(1-n)*e+n*t}e.lerp=t;function n(e,t,n){return e<t?t:e>n?n:e}e.clamp=n;function r(e,t,n,r,i,a){let o=(e-t)/(n-t)*(i-r)+r;if(a){let e=Math.max(r,i),t=Math.min(r,i);if(o>e)return e;if(o<t)return t}return o}e.lerpMap=r;function i(e,t,n){return t<=e&&e<=n}e.between=i})(R||={});var z;(function(e){function t(e){return Array(e).fill(0).map((e,t)=>t)}e.seq=t;function n(e,n){return t(n+1-e).map(t=>e+t)}e.range=n;function r(e,t){let n=0;for(;n<e.length;){if(e[n]===t){e.splice(n,1);continue}n++}}e.remove=r})(z||={});function Me(e,t,n,r){let i=Date.now(),a=i+r,o=!1,s=()=>{if(o)return;let r=Date.now();if(r>+a)e(n),o=!0;else{let o=1-(1-R.lerpMap(r,i,a,0,1,!0))**2;e(R.lerpMap(o,0,1,t,n)),requestAnimationFrame(s)}N()};return s(),{flush(){o||=(e(n),!0)}}}function Ne(){return window?.hostInterface}function Pe(e){Ne()?.setupUnitAgent({type:`instrument`,noteInput:{noteOn(t){e.noteOn(t),N()},noteOff(t){e.noteOff(t),N()}}})}function Fe(e){return{async initialize(){},get allDeviceEntries(){return[]},get currentDeviceId(){return``},selectDevice(e){}}}function B(e,t,n,r){for(let i=0;i<r;i++){let r=n+i;e[r]=t[r]}}function Ie(e,t,n,r){for(let i=0;i<n;i++){let n=t+i;e[n]*=r}}function V(e,t,n){let r=t*n;return e.slice(r,r+t)}function Le(e,t,n,r){let i=e.sampleRate,a=t,o=r.createBuffer(2,i*a,i),s=e.getChannelData(0),c=e.getChannelData(1),l=o.getChannelData(0),u=o.getChannelData(1),d=V(s,i*a,n),f=V(c,i*a,n);return B(l,d,0,i*a),B(u,f,0,i*a),o}function H(e){let{srcBuf:t,srcOffset:n,duration:r,destBuf:i,destOffset:a,v0:o,v1:s}=e;for(let e=0;e<r;e++){let c=R.lerpMap(e,0,r,o,s,!0);i[a+e]+=t[n+e]*c}}function Re(e,t,n,r,i,a=`SL`){let o=e.sampleRate,s=t,c=e.getChannelData(0),l=e.getChannelData(1),u=V(c,o*s,n),d=V(l,o*s,n),f=r.createBuffer(2,o*s,o),p=f.getChannelData(0),m=f.getChannelData(1),h=2**((i-69)/12)*440;if(a===`SL`){let e=.75,t=1/h,n=Math.floor(2/t)*t,r=o*e>>0,i=o*(e+n)>>0,a=o*.01>>0;function s(e,t){B(e,t,0,i-a),H({srcBuf:t,srcOffset:i-a,destBuf:e,destOffset:i-a,duration:a,v0:1,v1:0}),H({srcBuf:t,srcOffset:r-a,destBuf:e,destOffset:i-a,duration:a,v0:0,v1:1})}return s(p,u),s(m,d),{samples:f,loopSpec:{posLoopStart:r,posLoopEnd:i}}}else{let e=.75,t=1/h,n=Math.floor(1/t)*t,r=o*e>>0,i=o*(e+n)>>0,a=o*(e+n*2)>>0,s=o*n>>0,c=s>>1,l=i-c,g=i+c;function _(e,t){B(e,t,0,i),H({srcBuf:t,srcOffset:i,destBuf:e,destOffset:i,duration:s,v0:1,v1:0}),H({srcBuf:t,srcOffset:r,destBuf:e,destOffset:i,duration:s,v0:0,v1:1}),H({srcBuf:t,srcOffset:i,destBuf:e,destOffset:i,duration:c,v0:.5,v1:1}),H({srcBuf:t,srcOffset:g,destBuf:e,destOffset:g,duration:c,v0:1,v1:.5}),H({srcBuf:t,srcOffset:a,destBuf:e,destOffset:i,duration:c,v0:.5,v1:0}),H({srcBuf:t,srcOffset:l,destBuf:e,destOffset:g,duration:c,v0:0,v1:.5}),Ie(e,i,s,.667)}return _(p,u),_(m,d),{samples:f,loopSpec:{posLoopStart:i,posLoopEnd:a}}}}function U(e,t){return Array(t).fill(0).map((t,n)=>e+n*12)}function ze(){return[{instrumentKey:`piano`,sourcePath:`samples/freesound/piano_4s_c0c7.mp3`,sliceDuration:4,noteNumbers:U(24,8),looped:!1,gainAdjustment:1,releaseParam:.5},{instrumentKey:`elepi`,sourcePath:`samples/freesound/rhodes_4s_d1d6.mp3`,sliceDuration:4,noteNumbers:U(38,7),looped:!1,gainAdjustment:1,releaseParam:.7},{instrumentKey:`celesta`,sourcePath:`samples/freesound/celesta_4s_g2g6.mp3`,sliceDuration:4,noteNumbers:U(43,5),looped:!1,gainAdjustment:1,releaseParam:.7},{instrumentKey:`guitar`,sourcePath:`samples/freesound/guitar_4s_e3e6.mp3`,sliceDuration:4,noteNumbers:U(40,4),looped:!1,gainAdjustment:1,releaseParam:.5}]}function Be(){return[[`bell`,`steelbell.mp3`,!1,1.5,.9,void 0],[`ocarina`,`sleepy.mp3`,!0,1,.5,`SL`],[`bass1`,`bass2.mp3`,!1,1.4,.5,void 0],[`bass2`,`slidebass.mp3`,!0,1,.2,`SL`],[`pluck1`,`hipluck2.mp3`,!1,1,.5,void 0],[`pluck2`,`pluck1.mp3`,!1,4,.5,void 0],[`pluck3`,`brightkey.mp3`,!1,1,.7,void 0],[`pluck4`,`key_shiny.mp3`,!1,1,.7,void 0],[`brass1`,`trumpet.mp3`,!0,1,.4,`SL`],[`brass2`,`brass2.mp3`,!0,1.4,.5,`XF`],[`lead1`,`super1.mp3`,!0,.7,.7,`XF`],[`lead2`,`coldwave.mp3`,!0,.8,.5,`XF`],[`lead3`,`lead_bright.mp3`,!0,.4,.7,`XF`],[`lead4`,`finale.mp3`,!0,.8,.5,`XF`],[`pad1`,`softkey.mp3`,!1,1,.8,void 0],[`pad2`,`pad2.mp3`,!0,1,.7,`XF`],[`strings1`,`gradient.mp3`,!0,.8,.8,`XF`],[`strings2`,`slowstrings.mp3`,!1,1,.8,void 0],[`orchestra`,`grandwave.mp3`,!0,1,.8,`XF`],[`nes`,`chipwave.mp3`,!0,1,.4,`SL`]].map(e=>{let[t,n,r,i,a,o]=e;return{instrumentKey:t,pitched:!0,sourcePath:`samples/arctrax/${n}`,sliceDuration:4,noteNumbers:[33,45,57,69,81,93],looped:r,gainAdjustment:i,releaseParam:a,loopingMethod:o}})}async function Ve(e,t){let n=t.split(`/`).pop();console.log(`fetching ${n}`);let r=await(await fetch(t)).arrayBuffer();if(r.byteLength===0)throw Error(`invalid audio resource: ${t}`);return e.decodeAudioData(r)}async function He(e,t){let n=await Ve(t,e.sourcePath);return{sampleSources:e.noteNumbers.map((r,i)=>{if(e.looped){let{samples:a,loopSpec:o}=Re(n,e.sliceDuration,i,t,r,e.loopingMethod);return{noteNumber:r,samples:a,loopSpec:o}}else return{noteNumber:r,samples:Le(n,e.sliceDuration,i,t)}}),gainAdjustment:e.gainAdjustment,releaseParam:e.releaseParam}}var Ue={};async function We(e,t){return Ue[e.instrumentKey]||=await He(e,t)}function Ge(e){let t=[...ze(),...Be()],n=Ee.map(e=>{let n=t.find(t=>t.instrumentKey===e);if(!n)throw Error(`instrument definition not found for ${e}`);return n});return{allInstrumentKeys:Ee,loadInstrument(t){let r=n.find(e=>e.instrumentKey===t);if(!r)throw Error(`instrument definition not found for ${t}`);return We(r,e)},async preloadAllInstrumentSamples(){await Promise.all(n.map(t=>We(t,e)))}}}function Ke(e,t){let n=t.map(t=>Math.abs(t.noteNumber-e)),r=Math.min(...n);return t[n.indexOf(r)]}function qe(e,t,n,r,i,a){let o=e.sampleRate,s=Ke(t,n),c=2**((t-s.noteNumber)/12),l=e.createBufferSource();l.buffer=s.samples,l.playbackRate.value=c;let{loopSpec:u}=s;u&&(l.loop=!0,l.loopStart=u.posLoopStart/o,l.loopEnd=u.posLoopEnd/o);let d=!!u,{volume:f,release:p}=r,m=f*i,h=p*p*3e3,g=e.createGain();g.gain.value=m,l.connect(g).connect(a);let _=s.samples.duration/c*1e3,v=!0,y=0,b=0;function x(t,n,r){g.gain.setValueAtTime(t,e.currentTime);let i=e.currentTime+r/1e3;g.gain.linearRampToValueAtTime(n,i)}let ee=()=>{l.start(0),b=0},S=()=>{v=!1,y=0,x(m,0,h)},C=()=>{l.stop(),l.disconnect()};return{noteOn:ee,noteOff:S,update:e=>!v&&(y+=e,y>h)||(b+=e,!d&&b>_)?(C(),!0):!1,forceStop:()=>{v=!1,y=0,h=Math.min(h,50),x(g.gain.value,0,h)}}}function Je(){let e={},t=Ae();return{noteOn(t,n){let r=e[t];r&&(r.forceStop(),delete e[t]),n.noteOn(),e[t]=n},noteOff(t){let n=e[t];n&&n.noteOff()},updateVoices(){let n=t.next();for(let t in e){let r=e[t];r&&r.update(n)&&delete e[t]}}}}function Ye(e){return`note-${e}`}function Xe(){let e=Ne(),t=e?.audioContext??new AudioContext,n=Ge(t),{allInstrumentKeys:r}=n,i=Je(),a=t.createGain(),o=t.createDynamicsCompressor();a.connect(o).connect(e?.audioDestinationNode??t.destination);let s,c=1,l=!1,u,d=r[0],f=!1,p=!1,m=[],h={volume:.5,release:.4};function g(){a.gain.value=c}let _={allInstrumentKeys:n.allInstrumentKeys,get masterVolume(){return c},setMasterVolume(e){c=e,g()},get currentInstrumentKey(){return d},get webAudioInitialized(){return f},get noteReceived(){return p},instrumentParameters:h,holdNoteNumbers:m,setInstrumentParameter(e,t){h[e]=t},initialize(){g(),s=setInterval(()=>i.updateVoices(),50)},activateWebAudioOnUserAction(){f||(t.resume(),f=!0,console.log(`web audio started`),N())},get isLoadingSamples(){return l},async preloadAllInstrumentSamples(){return n.preloadAllInstrumentSamples()},async setInstrument(e,t){d=e,l=!0;let r=await n.loadInstrument(e);l=!1,d===e&&(u=r,t&&_.setInstrumentParameter(`release`,u.releaseParam),N())},noteOn(e,n){if(!u||l)return;let r=Ye(e),{sampleSources:o,gainAdjustment:s}=u,c=qe(t,e,o,h,s,a);i.noteOn(r,c),m.push(e),p=!0},noteOff(e){let t=Ye(e);i.noteOff(t),z.remove(m,e)},finalize(){s&&=(clearInterval(s),void 0)}};return _}var Ze=({unitWidthPx:e,heightPx:t,activeRangeOffsetU:n,activeRangeSizeU:r,children:i})=>{let a=e*r,o=-n*e;return M(T(`div`,null,T(`div`,{class:`inner`},i)),j`
    ...
    `)},Qe={languageKey:`en`,colors:{clPanelBody:`#aceefe88`,clForeground:`#fff`,clControlHighlight:`#0AF`,systemMessage:`#F08`}},$e=n(Qe);function W(){return r($e)}var G=`0.25s`,K=j`
  transition: all ${G} linear;
`,et=`Roboto`,tt=`'Noto Sans JP'`,nt=`'M PLUS 1p'`,rt=`Orbitron, sans-serif`,it=`Oxanium, sans-serif`,at=`${nt}, sans-serif`,ot=`Play, sans-serif`,st=`Play`;function ct(e,t){let{languageKey:n}=W();return n===`ja`?t:e}function lt(e,t){let{languageKey:n}=W();return n===`ja`?t:e}var ut={en:{instrument:`instrument`,volume:`volume`,release:`release`,midiIn:`MIDI IN`,none:`none`,msgNeedTapSomewhereToEnableAudioOutput:`Click somewhere to enable audio output.`},ja:{instrument:`音色`,volume:`音量`,release:`余韻`,midiIn:`MIDI IN`,none:`なし`,msgNeedTapSomewhereToEnableAudioOutput:`画面のどこかをクリックすると、オーディオ出力が有効になります。`}};function q(){let{languageKey:e}=Q.uiPresenter.state;return ut[e]}var J;(function(e){let t=.1,n=[0,1-t,1,2+t,2,3,4-t,4,5,5,6+t,6];function r(e,t){let r=e/12>>0,i=n[e%12];return t&&(i=Math.round(i)),r*7+i}e.getKeyOffsetInUnits=r;function i(e,t){return Math.floor(t+e*12/7)}e.getNoteNumberFormKeyOffset=i;let a=[1,3,6,8,10];function o(e){let t=e%12;return a.includes(t)}e.checkBlackKey=o;function s(e,t){let n=r(e,!0);return r(e+t,!0)-n}e.getKeysOuterWidthU=s})(J||={});function dt(e,t){if(!t)return;let n=e-t.rootNoteNumber;return t.labels[n]}var ft=({unitWidth:e,height:t,bottomNoteNumber:n,numKeys:r,holdNoteNumbers:i,onKeyHoldEvent:a,labelOptions:o,showCenterCMark:s,isMainKeys:c})=>{let l=`#f80b`,{getKeyOffsetInUnits:u,getKeysOuterWidthU:d,checkBlackKey:f}=J,p=z.range(n,n+r-1),m=u(n,!0),g=t*.63,_=e*.65,v=e*d(n,r)+1,y=h({playingNoteNumber:void 0}),b=e=>{a?.({noteNumber:e,hold:!0}),y.playingNoteNumber=e},x=()=>{y.playingNoteNumber&&(a?.({noteNumber:y.playingNoteNumber,hold:!1}),y.playingNoteNumber)},ee=(e,t)=>{b(t),I(e,{moveHandler(e,t){let n=document.elementFromPoint(t.clientX,t.clientY);if(n?.classList.contains(`keyblocks-playable-key`)){let e=parseInt(n.dataset.noteNumber||``);isFinite(e)&&e!==y.playingNoteNumber&&(x(),b(e),N())}},upHandler(){x(),N()}})},S=!!a,C=e/10>>0,te=`0 0 ${C}px ${C}px`,w=!!o;return M(T(`div`,null,p.map(t=>{let n=f(t),r=(u(t)-m)*e,a=i?.includes(t),c=dt(t,o),l=t===60&&s;return T(`div`,{key:t,class:[`key`,n&&`--black`,a&&`--hold`,S&&`--can-play`,S&&`keyblocks-playable-key`],style:{left:`${r}px`},onPointerDown:S&&(e=>ee(e,t))||void 0,onTouchStart:Oe,"data-note-number":t},T(`div`,{if:l,class:`center-c-mark`}),T(`div`,{if:c,class:`label`},c))}),T(`div`,{class:`cover`,if:c})),j`
      position: relative;
      width: ${v}px;
      height: ${t}px;
    ...
    `)},pt=({unitWidthPx:e,heightPx:t,bottomNoteNumber:n,numKeys:r,activeRangeOffsetU:i,activeRangeSizeU:a,onScrollActiveRange:o})=>{let s=J.getKeysOuterWidthU(n,r),c=e*s,l=i*e,u=a*e;return M(T(`div`,null,T(`div`,{class:`inner`,onPointerDown:t=>{I(t,{moveHandler(t){o(R.clamp(i+t.x/e,0,s-a)),N()}})}})),j`
      position: relative;
      width: ${c}px;
      height: ${t}px;
      > .inner {
    ...
    `)},mt=({options:e,value:t,onChange:n,width:r,disabled:i})=>{let a=r&&`width: ${r}px`||void 0,o=W().colors.clControlHighlight;return M(T(`select`,{value:e.length>0?t:``,onChange:ke(n),disabled:i,onKeyDown:e=>e.preventDefault(),style:a},e.map((e,t)=>{let n=typeof e==`string`?e:e.value,r=typeof e==`string`?e:e.label;return T(`option`,{value:n,key:t},r)})),j`
      ...
      font-family: ${ct(st,nt)},
        'sans-serif';

      font-size: ${lt(`16px`,`14px`)};
...
`,X=({spec:e,size:t})=>{if(e.startsWith(`ri-`)||e.startsWith(`ph-`))return T(`i`,{class:[e,Y(t)]});if(e.startsWith(`fa-`))return T(`i`,{class:[e,Y(t&&t*.85>>0)]});if(e.startsWith(`ti-`))return T(`i`,{class:[`ti`,e,Y(t)]});if(e.startsWith(`bi-`))return T(`i`,{class:[`bi`,e,Y(t&&t*.9>>0)]});if(e.startsWith(`mi `)){let n=e.replace(`mi `,``);return T(`i`,{class:[`material-icons`,Y(t)]},n)}if(e.startsWith(`mso `)){let n=e.replace(`mso `,``);return T(`span`,{class:[`material-symbols-outlined`,Y(t)]},n)}return T(`div`,null,`invalid iconSpec: `,e)},ht=({iconSpec:e,size:t,onClick:n,disabled:r})=>{let i=W().colors.clForeground;return M(T(`div`,{class:r&&`--disabled`,onClick:n},T(X,{spec:e,size:t})),j`
      cursor: pointer;
      ${K}
      color: ${i};
    ...
    `),j`
  color: red;
`;var yt=({isLoading:e})=>M(T(X,{spec:`ph-spinner`,size:24,class:e&&`--visible`}),j`
      @keyframes rotation1 {
        0% {
          transform: rotate(0);
        }
    ...
    `),bt=({height:e,asr:t=1.25,children:n,onClick:r,disabled:i})=>{let{colors:a}=W(),o=a.clControlHighlight,s=e*t>>0;return M(T(`div`,null,T(`div`,{onClick:r,class:[`inner`,i&&`--disabled`]},n)),j`
      width: ${s}px;
      height: ${e}px;
    ...
    `)},xt=({value:e,onChange:t,size:n})=>{let r=W().colors.clControlHighlight,i=`rotate(${R.lerpMap(e,0,1,125,415)})`,a=h({dragging:!1});return M(T(`div`,null,T(`div`,{class:`cover`}),T(`svg`,{viewBox:`-50 -50 100 100`,class:a.dragging&&`--dragging`},T(`circle`,{class:`knob`,cx:0,cy:0,r:49,onPointerDown:n=>{let r=e;a.dragging=!0,I(n,{moveHandler(e){t(R.clamp(r-e.y*.01,0,1)),N()},upHandler(){a.dragging=!1,N()}})}}),T(`circle`,{class:`knob_inner`,cx:0,cy:0,r:40}),T(`g`,{class:`marker`,transform:i},T(`line`,{x1:50*.25,y1:0,x2:45,y2:0})))),j`
    ...
    `)};function St(e,t=16){return e===`ja`?j`
      font-family: ${at};
      font-size: ${t*.9>>0}px;
      display: flex;
      align-items: center;
...
`;var Ct=({contentWidth:e,contentHeight:t,children:n})=>{let r=h({scale:1,mh:0,mv:0}),i=_(),a=i.current;if(a){let{clientWidth:n,clientHeight:i}=a;r.scale=Math.min(n/e,i/t),r.mh=Math.max((n-e*r.scale)/2,0),r.mv=Math.max((i-t*r.scale)/2,0)}else N();return g(N,[e,t]),M(T(`div`,{ref:i},T(`div`,{class:[`inner`,`bg-plane`],style:{width:`${e*r.scale}px`,height:`${t*r.scale}px`,marginLeft:`${r.mh}px`,marginTop:`${r.mv}px`}}),T(`div`,{class:`inner`,style:{width:`${e}px`,height:`${t}px`,transform:`scale(${r.scale}, ${r.scale})`,marginLeft:`${r.mh}px`,marginTop:`${r.mv}px`}},n)),j`
    ...
    `)},wt=({size:e})=>{let t=W().colors.clForeground;return M(T(`div`,null,T(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 30 30`,version:`1.1`,xmlns:`http://www.w3.org/2000/svg`,style:`fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;`},T(`g`,{transform:`matrix(1,0,0,1,-410.457,-257.386)`},T(`path`,{d:`M411.064,276.322C412.981,274.63 414.799,273.823 416.523,273.682C419.474,273.442 422.05,275.124 424.166,277.126C426.668,279.492 429.351,281.214 432.286,281.515C433.825,281.673 435.453,281.456 437.179,280.708C434.503,284.436 430.132,286.866 425.197,286.866C418.519,286.866 412.873,282.416 411.064,276.322ZM410.91,268.489C412.884,266.703 414.753,265.856 416.523,265.711C419.474,265.471 422.05,267.154 424.166,269.155C426.668,271.521 429.351,273.243 432.286,273.544C434.613,273.783 437.145,273.165 439.905,271.152C439.926,271.474 439.937,271.799 439.937,272.126C439.937,273.307 439.798,274.456 439.535,275.557C436.964,277.886 434.704,278.747 432.592,278.531C430.27,278.293 428.208,276.819 426.228,274.946C423.496,272.363 420.088,270.382 416.28,270.692C414.447,270.842 412.499,271.514 410.48,272.956C410.464,272.682 410.457,272.405 410.457,272.126C410.457,270.872 410.614,269.653 410.91,268.489ZM413.299,263.427C415.983,259.765 420.314,257.386 425.197,257.386C431.828,257.386 437.442,261.774 439.292,267.803C436.821,269.969 434.637,270.769 432.592,270.56C430.27,270.322 428.208,268.848 426.228,266.975C423.496,264.392 420.088,262.411 416.28,262.721C415.316,262.8 414.32,263.023 413.299,263.427Z`})))),j`
      width: ${e}px;
      height: ${e}px;
      fill: ${t};
    `)},Tt=({canGoPrev:e,canGoNext:t,onShift:n})=>M(T(`div`,null,T(bt,{height:30,onClick:()=>n(-1),disabled:!e},T(X,{spec:`ph-caret-left-fill`,size:20})),T(bt,{height:30,onClick:()=>n(1),disabled:!t},T(X,{spec:`ph-caret-right-fill`,size:20}))),j`
      display: flex;
      gap: 6px;
    `);function Et(e,t){for(let n=t.length-1;n>=0;n--){let r=t[n];if(r<e)return r}}function Dt(e,t){return t.find(t=>t>e)}function Ot(e){let t=P.octaveSelectionKeyUnitOffsets,n={keyRangeOffset:P.activeKeyRangeUnitOffsetDefault,keysRangeSize:P.activeKeyRangeUnitSize,languageKey:F.isJapaneseEnvironment?`ja`:`en`,usagePanelVisible:!1},r={get currentInstrumentIndex(){let{allInstrumentKeys:t,currentInstrumentKey:n}=e;return t.indexOf(n)},get canShiftInstrumentPrev(){return r.currentInstrumentIndex>0},get canShiftInstrumentNext(){let{allInstrumentKeys:t}=e;return r.currentInstrumentIndex<t.length-1},get canShiftKeysOffsetLower(){return n.keyRangeOffset>t[0]},get canShiftKeysOffsetHigher(){return n.keyRangeOffset<t[t.length-1]},get pcKeyboardRootNoteNumber(){let e=Et(n.keyRangeOffset+3.5,t)||0;return J.getNoteNumberFormKeyOffset(e,P.bottomNoteNumber)},get needUserActionForAudioOutput(){return!e.webAudioInitialized&&e.noteReceived}},i,a={setKeyRangeOffset(e){n.keyRangeOffset=e},shiftInstrument(t){let n=r.currentInstrumentIndex;if(n>=0){let{allInstrumentKeys:r}=e,i=r[n+t];i&&e.setInstrument(i,!0)}},shiftOctave(e){i?.flush();let r=n.keyRangeOffset,o=(e===1?Dt:Et)(r,t);o!==void 0&&(i=Me(a.setKeyRangeOffset,r,o,500))},setLanguageKey(e){F.isJapaneseEnvironment&&(n.languageKey=e)},showUsagePanel(){n.usagePanelVisible=!0},hideUsagePanel(){n.usagePanelVisible=!1}};return{state:n,readers:r,actions:a}}function kt(){let e=Xe(),t=Fe(e);return{synthEngine:e,midiInputDriver:t,uiPresenter:Ot(e),async initialize(){e.initialize(),e.setInstrument(e.currentInstrumentKey,!1),await t.initialize(),Pe(e)}}}var Q=kt();function At(){let e=`wavicle__app_persist_state`;return{load(){let t=localStorage.getItem(e);if(t)try{let{midiInDeviceId:e,currentInstrumentKey:n,instrumentParameters:r,languageKey:i,keyRangeOffset:a}=JSON.parse(t),{synthEngine:o,midiInputDriver:s,uiPresenter:c}=Q;s.allDeviceEntries.some(t=>t.id===e)&&s.selectDevice(e),o.allInstrumentKeys.includes(n)&&o.setInstrument(n,!1);let{volume:l,release:u}=r;R.between(l,0,1)&&R.between(u,0,1)&&(o.setInstrumentParameter(`volume`,l),o.setInstrumentParameter(`release`,u)),(i===`en`||i===`ja`)&&c.actions.setLanguageKey(i);let d=P.octaveSelectionKeyUnitOffsets[0],f=P.octaveSelectionKeyUnitOffsets[P.octaveSelectionKeyUnitOffsets.length-1];R.between(a,d,f)&&c.actions.setKeyRangeOffset(a)}catch{console.log(`failed to load persist state`)}},save(){let{synthEngine:t,midiInputDriver:n,uiPresenter:r}=Q,i=n.currentDeviceId,{currentInstrumentKey:a,instrumentParameters:o}=t,{state:{languageKey:s,keyRangeOffset:c}}=r,l={midiInDeviceId:i,currentInstrumentKey:a,instrumentParameters:o,languageKey:s,keyRangeOffset:c};localStorage.setItem(e,JSON.stringify(l))}}}var jt=At(),Mt=j`
  * {
    box-sizing: border-box;
    margin: 0;
    padding: 0;
...
`,Nt=()=>{let{showUsagePanel:e}=Q.uiPresenter.actions;return M(T(`div`,{class:`icon-buttons-box`},T(ht,{iconSpec:`ph-info`,size:40,onClick:e})),j`
      display: flex;
      justify-content: flex-end;
    `)},Pt=()=>{let{allInstrumentKeys:e,currentInstrumentKey:t,setInstrument:n,isLoadingSamples:r}=Q.synthEngine,{state:{languageKey:i},readers:{canShiftInstrumentPrev:a,canShiftInstrumentNext:o},actions:{shiftInstrument:s}}=Q.uiPresenter,c=q(),l=e.map(e=>({value:e,label:De(e,i)}));return M(T(`div`,null,T(`div`,{class:`head-row`},T(Z,{text:c.instrument})),T(`div`,{class:`second-row`},T(mt,{options:l,value:t,onChange:e=>{n(e,!0)},width:130}),T(yt,{isLoading:r})),T(`div`,{class:`buttons-row`},T(Tt,{canGoPrev:a,canGoNext:o,onShift:s}))),j`
      display: flex;
      flex-direction: column;
      > .head-row {
        display: flex;
    ...
    `)},Ft=()=>{let{bottomNoteNumber:e,numKeys:t}=P,{holdNoteNumbers:n}=Q.synthEngine,{state:{keyRangeOffset:r,keysRangeSize:i},actions:{setKeyRangeOffset:a}}=Q.uiPresenter;return M(T(`div`,null,T(ft,{unitWidth:10,height:33,bottomNoteNumber:e,numKeys:t,holdNoteNumbers:n,showCenterCMark:!1,isMainKeys:!1}),T(`div`,{class:`cover`},T(pt,{unitWidthPx:10,heightPx:33,bottomNoteNumber:e,numKeys:t,activeRangeOffsetU:r,activeRangeSizeU:i,onScrollActiveRange:a}))),j`
      position: relative;
      > .cover {
        position: absolute;
        z-index: 1;
    ...
    `)},It=()=>{let{clForeground:e,clControlHighlight:t}=W().colors,{state:{languageKey:n},actions:{setLanguageKey:r}}=Q.uiPresenter,i=W().colors.clControlHighlight;return M(T(`div`,null,T(`div`,{class:n===`en`&&`--active`,onClick:()=>r(`en`)},`EN`),T(`div`,{class:n===`ja`&&`--active`,onClick:()=>r(`ja`)},`JA`)),j`
      display: flex;
      justify-content: flex-end;
      margin: 4px;
      > div {
    ...
    `)},Lt=()=>{let{bottomNoteNumber:e,numKeys:t}=P,{holdNoteNumbers:n,noteOn:r,noteOff:i}=Q.synthEngine,{state:{keyRangeOffset:a,keysRangeSize:o}}=Q.uiPresenter,s=P.mainKeyUnitWidth;return M(T(Ze,{unitWidthPx:s,heightPx:254,activeRangeOffsetU:a,activeRangeSizeU:o},T(ft,{unitWidth:s,height:254,bottomNoteNumber:e,numKeys:t,holdNoteNumbers:n,onKeyHoldEvent:e=>{e.hold?r(e.noteNumber):i(e.noteNumber)},labelOptions:void 0,showCenterCMark:!1,isMainKeys:!0})),j`
      border-top: solid ${2}px #0004;
      border-left: solid ${3}px #0004;
      border-right: solid ${3}px #fff6;
      padding-bottom: 8px;
    `)},Rt=()=>{let{allDeviceEntries:e,currentDeviceId:t,selectDevice:n}=Q.midiInputDriver,r=q(),i=[{value:``,label:r.none},...e.map(e=>({value:e.id,label:e.name}))];return T(`div`,null,T(Z,{text:r.midiIn}),T(`div`,null,T(mt,{options:i,value:t,onChange:n,width:120})))},zt=()=>{let{readers:{canShiftKeysOffsetLower:e,canShiftKeysOffsetHigher:t},actions:{shiftOctave:n}}=Q.uiPresenter;return T(Tt,{canGoPrev:e,canGoNext:t,onShift:n})},Bt=()=>{let{instrumentParameters:e,setInstrumentParameter:t}=Q.synthEngine,n=q();return M(T(`div`,null,T(`div`,null,T(Z,{text:n.volume}),T(xt,{value:e.volume,onChange:e=>t(`volume`,e),size:50})),T(`div`,null,T(Z,{text:n.release}),T(xt,{value:e.release,onChange:e=>t(`release`,e),size:50}))),j`
      display: flex;
      gap: 15px;
      > div {
        width: 70px;
    ...
    `)},Vt=()=>{let{needUserActionForAudioOutput:e}=Q.uiPresenter.readers,t=q(),n=W();return M(T(`div`,null,T(`div`,{if:e},t.msgNeedTapSomewhereToEnableAudioOutput)),j`
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
      ...
      font-size: 14px;
      margin-top: 4px;
      color: ${n.colors.systemMessage};
    `)},Ht=()=>M(T(`div`,null,T(`div`,{class:`title-row`},T(wt,{size:44,class:`logo`}),T(`h1`,null,`Wavicle`))),j`
      position: absolute;
      top: 0;
      left: 0;
      > .title-row {
    ...
    `)},Gt=()=>{let e=`#4ae`,{hideUsagePanel:t}=Q.uiPresenter.actions;return M(T(`div`,null,T(`div`,{class:`panel`},T(`div`,{class:`top-bar`},T(ht,{iconSpec:`ph-x-bold`,size:30,onClick:t})),T(`div`,{class:`content-body`},T(Wt,null)))),j`
      > .panel {
        background: #fff;
        color: #333;
        border: solid 3px ${e};
    ...
    `)},Kt=()=>{let{colors:e}=W(),t=e.clForeground,n=e.clPanelBody;return M(T(`div`,null,T(`div`,{class:`top-row`},T(Pt,null),T(Bt,null),T(`div`,{class:`top-right-part`},T(Nt,null),T(It,{if:F.isJapaneseEnvironment})),T(Ht,null)),T(`div`,{class:`second-row`},T(`div`,{class:`keys-box`},T(zt,null),T(Ft,null)),T(Rt,{class:`midi-in-part`,if:F.isWebMidiSupported})),T(`div`,{class:`main-keys-row`},T(Lt,null)),T(Vt,null),T(`div`,{class:`cover`})),j`
      position: relative;
      padding: 15px 15px 0;
      background: ${n};
      border-radius: 2px;
    ...
    `)},qt=()=>{let{languageKey:e,usagePanelVisible:t}=Q.uiPresenter.state,n={...Qe,languageKey:e},r=ct(et,tt);return M(T($e.Provider,{value:n},T(`div`,null,T(Ct,{contentWidth:800,contentHeight:450,class:`scaler-box`},T(Kt,null)),T(Gt,{if:t}))),j`
      width: 100dvw;
      height: 100dvh;
      background: #aaa;
      display: flex;
    ...
    `)};async function Jt(){console.log(`wavicle ${P.versionCode}`),await Q.initialize(),jt.load(),xe(Mt),we(()=>T(qt,null),document.getElementById(`app`));let{activateWebAudioOnUserAction:e}=Q.synthEngine;window.addEventListener(`pointerdown`,e),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`hidden`&&jt.save()}),window.addEventListener(`resize`,je(N,100)),window.addEventListener(`contextmenu`,Oe)}window.addEventListener(`load`,Jt);