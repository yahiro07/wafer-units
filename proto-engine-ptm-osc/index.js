...
var i = (e, t) => e === t, a = Symbol("solid-proxy"), o = Symbol("solid-track"), s = { equals: i }, c = null, l = ge, u = 1, d = 2, f = {
	owned: null,
	cleanups: null,
	context: null,
	owner: null
...
function ne(e, t) {
	...
	return [ue.bind(n), (e) => (typeof e == "function" && (e = m && m.running && m.sources.has(n) ? e(n.tValue) : e(n.value)), de(n, e))];
}
function b(e, t, n) {
	let r = pe(e, t, !1, u);
	h && m && m.running ? v.push(r) : C(r);
}
function x(e, t, n) {
	n = n ? Object.assign({}, s, n) : s;
	let r = pe(e, t, !0, 0);
	return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, h && m && m.running ? (r.tState = u, v.push(r)) : C(r), ue.bind(r);
}
function re(e) {
	return w(e, !1);
}
...
function oe(e) {
	...
	return Promise.resolve().then(() => {
		...
		return (h || le) && (r = m ||= {
			...
			running: !0
		}, r.done ||= new Promise((e) => r.resolve = e), r.running = !0), w(e, !1), _ = p = null, r ? r.done : void 0;
	});
}
var [se, ce] = /* @__PURE__ */ ne(!1), le;
function ue() {
	let e = m && m.running;
	if (this.sources && (e ? this.tState : this.state)) if ((e ? this.tState : this.state) === u) C(this);
	else {
		let e = v;
		v = null, w(() => T(this), !1), v = e;
	}
	if (_) {
...
function de(e, t, n) {
	...
	if (!e.comparator || !e.comparator(r, t)) {
		...
		e.observers && e.observers.length && w(() => {
			for (let t = 0; t < e.observers.length; t += 1) {
				let n = e.observers[t], r = m && m.running;
				r && m.disposed.has(n) || ((r ? !n.tState : !n.state) && (n.pure ? v.push(n) : y.push(n), n.observers && ve(n)), r ? n.tState = u : n.state = u);
			}
...
function C(e) {
	...
	E(e);
	let t = ee;
	fe(e, m && m.running && m.sources.has(e) ? e.tValue : e.value, t), m && !m.running && m.sources.has(e) && queueMicrotask(() => {
		w(() => {
			m && (m.running = !0), _ = p = e, fe(e, e.tValue, t), _ = p = null;
		}, !1);
	});
}
function fe(e, t, n) {
	...
	try {
		...
		return e.pure && (m && m.running ? (e.tState = u, e.tOwned && e.tOwned.forEach(E), e.tOwned = void 0) : (e.state = u, e.owned && e.owned.forEach(E), e.owned = null)), e.updatedAt = n + 1, Se(t);
	} finally {
		_ = a, p = i;
	}
	(!e.updatedAt || e.updatedAt <= n) && (e.updatedAt != null && "observers" in e ? de(e, r, !0) : m && m.running && e.pure ? (m.sources.has(e) || (e.value = r), m.sources.add(e), e.tValue = r) : e.value = r, e.updatedAt = n);
}
function pe(e, t, n, r = u, i) {
	let a = {
		fn: e,
		state: r,
		updatedAt: null,
	...
	if (m && m.running && (a.state = 0, a.tState = r), p === null || p !== f && (m && m.running && p.pure ? p.tOwned ? p.tOwned.push(a) : p.tOwned = [a] : p.owned ? p.owned.push(a) : p.owned = [a]), g && a.fn) {
		let e = a.fn, [t, n] = ne(void 0, { equals: !1 }), r = g.factory(e, n);
		ie(() => r.dispose());
		let i, o = () => oe(n).then(() => {
			i &&= (i.dispose(), void 0);
		});
...
function me(e) {
	...
	if ((t ? e.tState : e.state) === d) return T(e);
	...
	for (let r = n.length - 1; r >= 0; r--) {
		...
		if ((t ? e.tState : e.state) === u) C(e);
		else if ((t ? e.tState : e.state) === d) {
			let t = v;
			v = null, w(() => T(e, n[0]), !1), v = t;
		}
	}
}
function w(e, t) {
	...
	try {
		...
		n || (y = null), v = null, Se(e);
	}
}
function he(e) {
	if (v &&= (h && m && m.running ? _e(v) : ge(v), null), e) return;
	let t;
	if (m) {
		if (!m.promises.size && !m.queue.size) {
			...
			m.running = !1, m.effects.push.apply(m.effects, y), y = null, ce(!0);
			return;
		}
	}
	let n = y;
	y = null, n.length && w(() => l(n), !1), t && t();
}
function ge(e) {
...
function T(e, t) {
	...
	for (let r = 0; r < e.sources.length; r += 1) {
		...
		if (i.sources) {
			...
			e === u ? i !== t && (!i.updatedAt || i.updatedAt < ee) && me(i) : e === d && T(i, t);
		}
	}
}
function ve(e) {
	...
	for (let n = 0; n < e.observers.length; n += 1) {
		let r = e.observers[n];
		(t ? !r.tState : !r.state) && (t ? r.tState = d : r.state = d, r.pure ? v.push(r) : y.push(r), r.observers && ve(r));
	}
}
function E(e) {
	let t;
...
function j(e, t, n, r, i) {
	...
	if (e = s && n[0] && n[0].parentNode || e, o === "string" || o === "number") {
		...
		if (Fe(o, t, n, i)) return b(() => n = j(e, o, n, r, !0)), () => n;
		if (a) {
		...
		if (o.length === 0) {
			if (n = M(e, n, r), s) return n;
		} else c ? n.length === 0 ? Ie(e, o, r) : De(e, n, o) : (n && M(e), Ie(e, o));
		n = o;
	} else if (t.nodeType) {
		if (a && t.parentNode) return n = s ? [t] : t;
		if (Array.isArray(n)) {
			if (s) return n = M(e, n, r, t);
			M(e, n, null, t);
...
function Fe(e, t, n, r) {
	...
	for (let a = 0, o = t.length; a < o; a++) {
		...
		else if (Array.isArray(o)) i = Fe(e, o, s) || i;
		else if (c === "function") if (r) {
			for (; typeof o == "function";) o = o();
			i = Fe(e, Array.isArray(o) ? o : [o], Array.isArray(s) ? s : [s]) || i;
		} else e.push(o), i = !0;
		else {
			let t = String(o);
...
var Le = ".flex-h{display:flex}.flex-hs{align-items:start;display:flex}.flex-ha{align-items:center;display:flex}.flex-v{flex-direction:column;display:flex}.flex-vl{flex-direction:column;align-items:flex-start;display:flex}.flex-va{flex-direction:column;align-items:center;display:flex}.flex-c{justify-content:center;align-items:center;display:flex}.flex-vc{flex-direction:column;justify-content:center;align-items:center;display:flex}.absolute-full{position:absolute;inset:0}.bd-red{border:1px solid red}.bd-blue{border:1px solid #00f}";
//#endregion
...
var Ve = Symbol("store-raw"), N = Symbol("store-node"), P = Symbol("store-has"), He = Symbol("store-self");
function Ue(e) {
	let t = e[a];
...
function I(e, t = /* @__PURE__ */ new Set()) {
	...
	if (!F(e) || t.has(e)) return e;
	if (Array.isArray(e)) {
		Object.isFrozen(e) ? e = e.slice(0) : t.add(e);
		for (let n = 0, a = e.length; n < a; n++) i = e[n], (r = I(i, t)) !== i && (e[n] = r);
	} else {
		Object.isFrozen(e) ? e = Object.assign({}, e) : t.add(e);
		let n = Object.keys(e), o = Object.getOwnPropertyDescriptors(e);
		for (let s = 0, c = n.length; s < c; s++) a = n[s], !o[a].get && (i = e[a], (r = I(i, t)) !== i && (e[a] = r));
	}
	return e;
}
function L(e, t) {
...
function We(e, t) {
	...
	return !n || n.get || !n.configurable || t === a || t === N ? n : (delete n.value, delete n.writable, n.get = () => e[a][t], n);
}
function Ge(e) {
	ae() && R(L(e, N), He)();
}
...
var qe = {
	get(e, t, n) {
		...
		let r = L(e, N), i = r[t], s = i ? i() : e[t];
		if (t === N || t === P || t === "__proto__") return s;
		if (!i) {
			let n = Object.getOwnPropertyDescriptor(e, t);
			ae() && (typeof s != "function" || e.hasOwnProperty(t)) && !(n && n.get) && (s = R(r, t, s)());
		}
		return F(s) ? Ue(s) : s;
	},
	has(e, t) {
		return t === Ve || t === a || t === o || t === N || t === P || t === "__proto__" ? !0 : (ae() && R(L(e, P), t)(), t in e);
	},
	set() {
		return !0;
	},
...
function z(e, t, n, r = !1) {
	...
	n === void 0 ? (delete e[t], e[P] && e[P][t] && i !== void 0 && e[P][t].$()) : (e[t] = n, e[P] && e[P][t] && i === void 0 && e[P][t].$());
	let o = L(e, N), s;
	if ((s = R(o, t, i)) && s.$(() => n), Array.isArray(e) && e.length !== a) {
		for (let t = e.length; t < a; t++) (s = o[t]) && s.$();
		(s = R(o, "length", a)) && s.$(e.length);
	}
	(s = o[He]) && s.$();
}
function Je(e, t) {
...
function B(e, t, n = []) {
	...
	if (t.length > 1) {
		...
		if (Array.isArray(r)) {
			for (let i = 0; i < r.length; i++) B(e, [r[i]].concat(t), n);
			return;
		} else if (o && a === "function") {
			for (let i = 0; i < e.length; i++) r(e[i], i) && B(e, [i].concat(t), n);
			return;
		} else if (o && a === "object") {
			let { from: i = 0, to: a = e.length - 1, by: o = 1 } = r;
			for (let r = i; r <= a; r += o) B(e, [r].concat(t), n);
			return;
		} else if (t.length > 1) {
			B(e[r], t, [r].concat(n));
			return;
	...
	let a = t[0];
	typeof a == "function" && (a = a(i, n), a === i) || r === void 0 && a == null || (a = I(a), r === void 0 || F(i) && F(a) && !Array.isArray(a) ? Je(i, a) : z(e, r, a));
}
function Ze(...[e, t]) {
	let n = I(e || {}), r = Array.isArray(n), i = Ue(n);
	function a(...e) {
		re(() => {
			r && e.length === 1 ? Xe(n, e[0]) : B(n, e);
		});
	}
	return [i, a];
}
...
function tt(e, t, n, r, i, a) {
	if (n === t) return r;
	let o = (e - t) / (n - t) * (i - r) + r;
	return a ? W(o, Math.min(r, i), Math.max(r, i)) : o;
}
function K(e, t, n) {
	return (1 - n) * e + n * t;
}
...
function gt(e, t, n) {
	let r = e.createGain(), i = {
		attack: q(t.attack) * n.attackMaxSec,
		decay: q(t.decay) * n.decayMaxSec,
		release: q(t.release) * n.releaseMaxSec
	}, { gain: a } = r;
	return {
		node: r,
		getReleaseTime() {
...
function _t(e, t) {
	...
	return {
		...
		updateNodeParameters(e) {
			...
			let i = t - 12, a = t + 48, o = st(W(G(e.cutoff, i, a), 0, 127));
			n.frequency.value !== o && (n.frequency.value = o);
			let s = G(q(e.peak), 0, 36);
...
function vt(e, t) {
	...
	return {
		...
		updateNodeParameters(e) {
			r.setEnabled(e.enabled);
			let i = t - 24, a = st(W(G(e.cutoff, i, 127), 0, 127));
			n.frequency.value !== a && (n.frequency.value = a);
			let o = G(q(e.peak), 0, 36);
...
function St(e, t, n) {
	...
	for (let t = 0; t < r; t++) e[t] = a((t / (r - 1) * 2 - 1) * (1 + q(n) * i.maxGain));
}
var Ct = ft(1024, St);
function wt(e) {
	let t = e.createWaveShaper();
...
var Et = Math.PI * 2, Dt = Math.PI / 2, Ot = Math.PI, kt = {
	...
	drill(e, t) {
		let n = G(t, .25, 1), r = e, i = r * (1 + q(n) * 15), a = i % 1 < .5 ? 0 : 1;
	...
	sdm(e, t) {
		let n = G(t, 1, 100), r = e * n, i = Math.floor(r), a = i + 1, o = r - i, s = e;
		return [K(s, K(s, K(i === 0 ? 0 : At[i], At[a], o), t), t), n];
	},
	creep(e, t) {
		let n = 1 + t * 31, r = G(t, 1, 0), i = -Math.cos(it(e) * Ot * n) * .5 + .5, a = G(e, 1, r), o = G(it(t), 1, 1.07);
		return [W(i * a * o, 0, 1), n];
	},
	creep2(e, t) {
		let n = 1 + q(t) * 31;
	...
	squash(e, t) {
		return [ot(e + q(t) * 4 * Math.tanh(3 * (2 * e - 1))) * 1, 1 + t * 4];
	},
	sinus(e, t) {
...
var J = ct("wus-v01", import.meta.url);
function Rt(e, t) {
	return st(e + t * 12);
}
function zt() {
...
function Vt(e, t) {
	...
	return {
		...
		updateNodeParameters(e) {
			...
			let o = Bt.update(e.wave, e.shape);
			o !== a && (r.curve = o, a = o);
		}
	};
}
function Ht(e, t) {
	let { audioContext: n, voiceDestinationNode: r } = e, i = Vt(n, t), a = _t(n, t), o = vt(n, t), s = wt(n), c = n.createGain(), l = e.synthParameters, u = gt(n, {
		attack: l.ampAttack,
		decay: l.ampDecay,
...
var Y = Wt(), X = {
	noteOn(e, t = 0, n = 1) {
		Y.noteOn(e, t), U("notes", (t) => [...t, e]);
	},
	noteOff(e, t = 0) {
		Y.noteOff(e, t), U("notes", (t) => t.filter((t) => t !== e));
	},
	setSynthParam(e, t) {
		U("synthParams", e, t), Y.setParameter(e, t);
	},
	loadStates(e) {
		U("synthParams", e.synthParams), Y.setAllParameters(e.synthParams);
	}
};
//#endregion
...
var Gt = {
	...
	emitStateBytes() {
		let { synthParams: e } = H, t = Gt.serializeParameters(e);
		return new Uint8Array([Kt, ...t]);
	},
	applyStateBytes(e) {
		if (e.length === 21 && e[0] === Kt) {
			let t = Gt.deserializeParameters([...e.slice(1)]);
...
var Yt = /* @__PURE__ */ O("<div class=\"flex-ha h-8 text-[10px] tracking-[0.12em] text-[#d7dfeb] gap-2\"><div class=\"w-[72px] text-[#a8b4c0]\"></div><input type=range class=\"flex-1 accent-[#2ec965]\"><div class=\"w-[22px] text-right text-[#f8f8f8]\">");
function Xt(e) {
	let t = e.step && e.step >= 1;
	return (() => {
		var n = Yt(), r = n.firstChild, i = r.nextSibling, a = i.nextSibling;
		return A(r, () => e.label), i.$$input = (t) => e.onChange(Number(t.currentTarget.value)), A(a, () => t ? Math.round(e.value) : e.value.toFixed(2)), b((t) => {
			var n = e.min ?? 0, r = e.max ?? 1, a = e.step ?? .01;
			return n !== t.e && k(i, "min", t.e = n), r !== t.t && k(i, "max", t.t = r), a !== t.a && k(i, "step", t.a = a), t;
		}, {
			e: void 0,
			t: void 0,
			a: void 0
...
var Zt = /* @__PURE__ */ O("<button type=button>"), Qt = /* @__PURE__ */ O("<div class=\"w-full flex-ha justify-between bg-indigo-800 py-1.5 px-2 text-[11px] tracking-[0.16em] text-[#dbe4ec] gap-2 mb-0.5\"><div class=\"flex-ha gap-1\"><span>");
function $t(e) {
	return (() => {
		var t = Qt(), n = t.firstChild.firstChild;
		return A(n, () => e.title), A(t, D(Te, {
			get when() {
				return e.withIndicator;
			},
			get children() {
				var t = Zt();
				return Me(t, "click", e.onToggleIndicator, !0), b(() => je(t, `w-4 h-4 border ${e.enabled ? "border-[#72ffa4] bg-[#2d6d45]" : "border-[#6c7b8b] bg-[#212a35]"}`)), t;
			}
		}), null), t;
	})();
}
...
var en = /* @__PURE__ */ O("<div class=bg-[#222]><svg viewBox=\"0 0 160 90\"width=160 height=90><path stroke=#08f fill=#08f4>");
function tn(e, t, n) {
	return `${[
		[0, n / 2],
...
function nn(e) {
	let t = ft(64, Nt), n = x(() => tn(t.update(e.wave, e.shape), 160, 90));
	return (() => {
		var e = en(), t = e.firstChild.firstChild;
		return b(() => k(t, "d", n())), e;
	})();
}
//#endregion
//#region src/sections/main-view.tsx
var rn = /* @__PURE__ */ O("<div class=\"flex-c gap-4 bg-gray-700\"><div class=\"flex-vc gap-4 bg-zinc-900 w-[800px] h-[380px]\"><div class=\"flex-h gap-6\"><div class=\"flex-vc gap-1 mb-[-20px]\"><div class=\"pt-2 pb-1\"></div></div><div class=\"flex-vl gap-1\"><div class=h-2></div></div><div class=\"flex-vl gap-1\"></div></div><div class=\"flex-h gap-6 \"><div class=\"w-[240px] flex-v text-white gap-1 pt-2 justify-end\"><div class=flex-vc><div>proto-engine-ptm-osc</div><div class=text-white></div></div></div><div class=\"flex-vl gap-1\"></div><div class=\"flex-vl gap-1 mt-[-36px]\">");
function $(e) {
	return D(Xt, {
		get label() {
			return e.label;
		...
		get value() {
			return H.synthParams[e.paramKey];
		},
...
function sn(e) {
	return D($t, {
		...
		withIndicator: !0,
		onToggleIndicator: () => X.setSynthParam(e.paramKey, !H.synthParams[e.paramKey])
	});
}
function cn() {
	return (() => {
		var e = rn(), t = e.firstChild.firstChild, n = t.firstChild, r = n.firstChild, i = n.nextSibling, a = i.firstChild, o = i.nextSibling, s = t.nextSibling.firstChild, c = s.firstChild.firstChild.nextSibling, l = s.nextSibling, u = l.nextSibling;
		return A(n, D($t, { title: "oscillator" }), r), A(r, D(nn, {
			get wave() {
				return H.synthParams.oscWave;
			},
			get shape() {
				return H.synthParams.oscShape;
			}
		})), A(n, D(on, {
			paramKey: "oscWave",
			label: "osc_wave",
			...
			paramKey: "filterPeak",
			label: "filter_peak"
		}), null), A(o, D($t, { title: "amplifier" }), null), A(o, D($, {
			paramKey: "ampAttack",
			label: "amp_attack"
		}), null), A(o, D($, {
			paramKey: "ampDecay",
			...
			var e = Ee(() => H.notes.length > 0);
			return () => e() ? `${H.notes.length}voices active` : "--";
		})()), A(s, D($, {
			...
			label: "shaper_level"
		}), null), A(u, D($t, { title: "effects" }), null), A(u, D($, {
...
var un = "@import \"https://fonts.googleapis.com/css2?family=Inter:wght@400..700&display=swap\";@layer components;@layer properties{@supports (((-webkit-hyphens:none)) and (not (margin-trim:inline))) or ((-moz-orient:inline) and (not (color:rgb(from red r g b)))){*,:before,:after,::backdrop{--tw-border-style:solid;--tw-leading:initial;--tw-tracking:initial;--tw-blur:initial;--tw-brightness:initial;--tw-contrast:initial;--tw-grayscale:initial;--tw-hue-rotate:initial;--tw-invert:initial;--tw-opacity:initial;--tw-saturate:initial;--tw-sepia:initial;--tw-drop-shadow:initial;--tw-drop-shadow-color:initial;--tw-drop-shadow-alpha:100%;--tw-drop-shadow-size:initial}}}@layer theme{:root,:host{--font-sans:ui-sans-serif, system-ui, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";--font-mono:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace;--color-indigo-800:oklch(39.8% .195 277.366);--color-gray-700:oklch(37.3% .034 259.733);--color-zinc-900:oklch(21% .006 285.885);--color-white:#fff;--spacing:.25rem;--default-font-family:var(--font-sans);--default-mono-font-family:var(--font-mono)}}@layer base{*,:after,:before,::backdrop{box-sizing:border-box;border:0 solid;margin:0;padding:0}::file-selector-button{box-sizing:border-box;border:0 solid;margin:0;padding:0}html,:host{-webkit-text-size-adjust:100%;tab-size:4;line-height:1.5;font-family:var(--default-font-family,ui-sans-serif, system-ui, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\");font-feature-settings:var(--default-font-feature-settings,normal);font-variation-settings:var(--default-font-variation-settings,normal);-webkit-tap-highlight-color:transparent}hr{height:0;color:inherit;border-top-width:1px}abbr:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;-webkit-text-decoration:inherit;-webkit-text-decoration:inherit;-webkit-text-decoration:inherit;-webkit-text-decoration:inherit;text-decoration:inherit}b,strong{font-weight:bolder}code,kbd,samp,pre{font-family:var(--default-mono-font-family,ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace);font-feature-settings:var(--default-mono-font-feature-settings,normal);font-variation-settings:var(--default-mono-font-variation-settings,normal);font-size:1em}small{font-size:80%}sub,sup{vertical-align:baseline;font-size:75%;line-height:0;position:relative}sub{bottom:-.25em}sup{top:-.5em}table{text-indent:0;border-color:inherit;border-collapse:collapse}:-moz-focusring{outline:auto}progress{vertical-align:baseline}summary{display:list-item}ol,ul,menu{list-style:none}img,svg,video,canvas,audio,iframe,embed,object{vertical-align:middle;display:block}img,video{max-width:100%;height:auto}button,input,select,optgroup,textarea{font:inherit;font-feature-settings:inherit;font-variation-settings:inherit;letter-spacing:inherit;color:inherit;opacity:1;background-color:#0000;border-radius:0}::file-selector-button{font:inherit;font-feature-settings:inherit;font-variation-settings:inherit;letter-spacing:inherit;color:inherit;opacity:1;background-color:#0000;border-radius:0}:where(select:is([multiple],[size])) optgroup{font-weight:bolder}:where(select:is([multiple],[size])) optgroup option{padding-inline-start:20px}::file-selector-button{margin-inline-end:4px}::placeholder{opacity:1}@supports (not ((-webkit-appearance:-apple-pay-button))) or (contain-intrinsic-size:1px){::placeholder{color:currentColor}@supports (color:color-mix(in lab, red, red)){::placeholder{color:color-mix(in oklab, currentcolor 50%, transparent)}}}textarea{resize:vertical}::-webkit-search-decoration{-webkit-appearance:none}::-webkit-date-and-time-value{min-height:1lh;text-align:inherit}::-webkit-datetime-edit{display:inline-flex}::-webkit-datetime-edit-fields-wrapper{padding:0}::-webkit-datetime-edit{padding-block:0}::-webkit-datetime-edit-year-field{padding-block:0}::-webkit-datetime-edit-month-field{padding-block:0}::-webkit-datetime-edit-day-field{padding-block:0}::-webkit-datetime-edit-hour-field{padding-block:0}::-webkit-datetime-edit-minute-field{padding-block:0}::-webkit-datetime-edit-second-field{padding-block:0}::-webkit-datetime-edit-millisecond-field{padding-block:0}::-webkit-datetime-edit-meridiem-field{padding-block:0}::-webkit-calendar-picker-indicator{line-height:1}:-moz-ui-invalid{box-shadow:none}button,input:where([type=button],[type=reset],[type=submit]){appearance:button}::file-selector-button{appearance:button}::-webkit-inner-spin-button{height:auto}::-webkit-outer-spin-button{height:auto}[hidden]:where(:not([hidden=until-found])){display:none!important}*{box-sizing:border-box;margin:0;padding:0}}@layer utilities{.mt-\\[-36px\\]{margin-top:-36px}.mb-0\\.5{margin-bottom:calc(var(--spacing) * .5)}.mb-\\[-20px\\]{margin-bottom:-20px}.flex{display:flex}.h-2{height:calc(var(--spacing) * 2)}.h-4{height:calc(var(--spacing) * 4)}.h-7{height:calc(var(--spacing) * 7)}.h-8{height:calc(var(--spacing) * 8)}.h-\\[8px\\]{height:8px}.h-\\[380px\\]{height:380px}.h-full{height:100%}.w-4{width:calc(var(--spacing) * 4)}.w-\\[22px\\]{width:22px}.w-\\[72px\\]{width:72px}.w-\\[80px\\]{width:80px}.w-\\[240px\\]{width:240px}.w-\\[800px\\]{width:800px}.w-full{width:100%}.flex-1{flex:1}.cursor-pointer{cursor:pointer}.flex-col-reverse{flex-direction:column-reverse}.justify-between{justify-content:space-between}.justify-end{justify-content:flex-end}.gap-1{gap:calc(var(--spacing) * 1)}.gap-2{gap:calc(var(--spacing) * 2)}.gap-4{gap:calc(var(--spacing) * 4)}.gap-6{gap:calc(var(--spacing) * 6)}.gap-\\[2px\\]{gap:2px}.border{border-style:var(--tw-border-style);border-width:1px}.border-\\[\\#6c7b8b\\]{border-color:#6c7b8b}.border-\\[\\#7df7a0\\]{border-color:#7df7a0}.border-\\[\\#72ffa4\\]{border-color:#72ffa4}.border-\\[\\#444\\]{border-color:#444}.border-\\[\\#63717f\\]{border-color:#63717f}.border-\\[\\#243342\\]{border-color:#243342}.border-\\[\\#485462\\]{border-color:#485462}.border-\\[\\#617081\\]{border-color:#617081}.border-\\[\\#ffb16f\\]{border-color:#ffb16f}.border-\\[\\#ffd861\\]{border-color:#ffd861}.bg-\\[\\#1a222d\\]{background-color:#1a222d}.bg-\\[\\#1b232d\\]{background-color:#1b232d}.bg-\\[\\#2d6d45\\]{background-color:#2d6d45}.bg-\\[\\#62d581\\]{background-color:#62d581}.bg-\\[\\#212a35\\]{background-color:#212a35}.bg-\\[\\#222\\]{background-color:#222}.bg-\\[\\#18242f\\]{background-color:#18242f}.bg-\\[\\#091015\\]{background-color:#091015}.bg-\\[\\#473405\\]{background-color:#473405}.bg-\\[\\#f58f45\\]{background-color:#f58f45}.bg-gray-700{background-color:var(--color-gray-700)}.bg-indigo-800{background-color:var(--color-indigo-800)}.bg-zinc-900{background-color:var(--color-zinc-900)}.px-2{padding-inline:calc(var(--spacing) * 2)}.py-1\\.5{padding-block:calc(var(--spacing) * 1.5)}.py-2{padding-block:calc(var(--spacing) * 2)}.pt-2{padding-top:calc(var(--spacing) * 2)}.pb-1{padding-bottom:calc(var(--spacing) * 1)}.text-right{text-align:right}.text-\\[10px\\]{font-size:10px}.text-\\[11px\\]{font-size:11px}.leading-none{--tw-leading:1;line-height:1}.tracking-\\[0\\.12em\\]{--tw-tracking:.12em;letter-spacing:.12em}.tracking-\\[0\\.14em\\]{--tw-tracking:.14em;letter-spacing:.14em}.tracking-\\[0\\.16em\\]{--tw-tracking:.16em;letter-spacing:.16em}.text-\\[\\#a8b4c0\\]{color:#a8b4c0}.text-\\[\\#c7d2de\\]{color:#c7d2de}.text-\\[\\#d7dfeb\\]{color:#d7dfeb}.text-\\[\\#dbe4ec\\]{color:#dbe4ec}.text-\\[\\#eef5ff\\]{color:#eef5ff}.text-\\[\\#f8f8f8\\]{color:#f8f8f8}.text-\\[\\#ffd861\\]{color:#ffd861}.text-white{color:var(--color-white)}.accent-\\[\\#2ec965\\]{accent-color:#2ec965}.filter{filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}}body{-webkit-user-select:none;user-select:none;min-height:100dvh;font-family:Inter,sans-serif}@property --tw-border-style{syntax:\"*\";inherits:false;initial-value:solid}@property --tw-leading{syntax:\"*\";inherits:false}@property --tw-tracking{syntax:\"*\";inherits:false}@property --tw-blur{syntax:\"*\";inherits:false}@property --tw-brightness{syntax:\"*\";inherits:false}@property --tw-contrast{syntax:\"*\";inherits:false}@property --tw-grayscale{syntax:\"*\";inherits:false}@property --tw-hue-rotate{syntax:\"*\";inherits:false}@property --tw-invert{syntax:\"*\";inherits:false}@property --tw-opacity{syntax:\"*\";inherits:false}@property --tw-saturate{syntax:\"*\";inherits:false}@property --tw-sepia{syntax:\"*\";inherits:false}@property --tw-drop-shadow{syntax:\"*\";inherits:false}@property --tw-drop-shadow-color{syntax:\"*\";inherits:false}@property --tw-drop-shadow-alpha{syntax:\"<percentage>\";inherits:false;initial-value:100%}@property --tw-drop-shadow-size{syntax:\"*\";inherits:false}", dn = class extends HTMLElement {
	...
	connectedCallback() {
		...
		e.dataset.unit1Styles = "true", e.textContent = un + Le, this.shadowRoot.appendChild(e), this.disposeRender = ke(() => D(ln, {}), this.shadowRoot), this.isMounted = !0;
	}
