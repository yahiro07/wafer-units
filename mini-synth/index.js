...
var i = (e, t) => e === t, a = Symbol("solid-proxy"), o = typeof Proxy == "function", s = Symbol("solid-track"), c = { equals: i }, l = null, u = ge, d = 1, f = 2, p = {
	owned: null,
	cleanups: null,
	context: null,
	owner: null
...
function C(e, t) {
	...
	return [de.bind(n), (e) => (typeof e == "function" && (e = h && h.running && h.sources.has(n) ? e(n.tValue) : e(n.value)), fe(n, e))];
}
function w(e, t, n) {
	let r = me(e, t, !1, d);
	g && h && h.running ? y.push(r) : E(r);
}
function ee(e, t, n) {
	u = ve;
	let r = me(e, t, !1, d), i = ue && le(ue);
	i && (r.suspense = i), (!n || !n.render) && (r.user = !0), b ? b.push(r) : E(r);
}
function te(e, t, n) {
	n = n ? Object.assign({}, c, n) : c;
	let r = me(e, t, !0, 0);
	return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, g && h && h.running ? (r.tState = d, y.push(r)) : E(r), de.bind(r);
}
function ne(e) {
	return O(e, !1);
}
...
function de() {
	let e = h && h.running;
	if (this.sources && (e ? this.tState : this.state)) if ((e ? this.tState : this.state) === d) E(this);
	else {
		let e = y;
		y = null, O(() => k(this), !1), y = e;
	}
	if (v) {
	...
	if (!e.comparator || !e.comparator(r, t)) {
		...
		e.observers && e.observers.length && O(() => {
			for (let t = 0; t < e.observers.length; t += 1) {
				...
				r && h.disposed.has(n) || ((r ? !n.tState : !n.state) && (n.pure ? y.push(n) : b.push(n), n.observers && ye(n)), r ? n.tState = d : n.state = d);
			}
...
function E(e) {
	...
	A(e);
	let t = x;
	pe(e, h && h.running && h.sources.has(e) ? e.tValue : e.value, t), h && !h.running && h.sources.has(e) && queueMicrotask(() => {
		O(() => {
			h && (h.running = !0), v = m = e, pe(e, e.tValue, t), v = m = null;
		}, !1);
	});
}
function pe(e, t, n) {
	...
	try {
		...
		return e.pure && (h && h.running ? (e.tState = d, e.tOwned && e.tOwned.forEach(A), e.tOwned = void 0) : (e.state = d, e.owned && e.owned.forEach(A), e.owned = null)), e.updatedAt = n + 1, Ce(t);
	} finally {
		v = a, m = i;
	}
	(!e.updatedAt || e.updatedAt <= n) && (e.updatedAt != null && "observers" in e ? fe(e, r, !0) : h && h.running && e.pure ? (h.sources.has(e) || (e.value = r), h.sources.add(e), e.tValue = r) : e.value = r, e.updatedAt = n);
}
function me(e, t, n, r = d, i) {
	let a = {
		fn: e,
		state: r,
		updatedAt: null,
...
function D(e) {
	...
	if ((t ? e.tState : e.state) === f) return k(e);
	...
	for (let r = n.length - 1; r >= 0; r--) {
		...
		if ((t ? e.tState : e.state) === d) E(e);
		else if ((t ? e.tState : e.state) === f) {
			let t = y;
			y = null, O(() => k(e, n[0]), !1), y = t;
		}
	}
}
function O(e, t) {
	...
	try {
		...
		n || (b = null), y = null, Ce(e);
	}
}
function he(e) {
	if (y &&= (g && h && h.running ? _e(y) : ge(y), null), e) return;
	let t;
	if (h) {
		if (!h.promises.size && !h.queue.size) {
			...
			h.running = !1, h.effects.push.apply(h.effects, b), b = null, ce(!0);
			return;
		}
	}
	let n = b;
...
function k(e, t) {
	...
	for (let r = 0; r < e.sources.length; r += 1) {
		...
		if (i.sources) {
			...
			e === d ? i !== t && (!i.updatedAt || i.updatedAt < x) && D(i) : e === f && k(i, t);
		}
	}
}
function ye(e) {
	...
	for (let n = 0; n < e.observers.length; n += 1) {
		let r = e.observers[n];
		(t ? !r.tState : !r.state) && (t ? r.tState = f : r.state = f, r.pure ? y.push(r) : b.push(r), r.observers && ye(r));
	}
}
function A(e) {
	let t;
...
function be(e, t) {
	if (t || (e.tState = 0, h.disposed.add(e)), e.owned) for (let t = 0; t < e.owned.length; t++) be(e.owned[t]);
}
function xe(e) {
...
function Ce(e, t = m) {
	let n = l && t && t.context && t.context[l], r = xe(e);
	if (!n) throw r;
	b ? b.push({
		fn() {
			Se(r, n, t);
...
function Ee(e, t, n = {}) {
	...
	return ie(() => Te(a)), () => {
		...
		return l[s], T(() => {
			...
			if (u === 0) o !== 0 && (Te(a), a = [], r = [], i = [], o = 0, c &&= []), n.fallback && (r = [we], i[0] = S((e) => (a[0] = e, n.fallback())), o = 1);
			else if (o === 0) {
...
function Ae(...e) {
	...
	for (let n = 0; n < e.length; n++) {
		let r = e[n];
		t ||= !!r && a in r, e[n] = typeof r == "function" ? (t = !0, te(r)) : r;
	}
	if (o && t) return new Proxy({
		...
		has(t) {
			for (let n = e.length - 1; n >= 0; n--) if (t in N(e[n])) return !0;
			return !1;
		},
		keys() {
			let t = [];
			for (let n = 0; n < e.length; n++) t.push(...Object.keys(N(e[n])));
			return [...new Set(t)];
		}
	}, Oe);
...
function je(e) {
	...
	return te(Ee(() => e.each, e.children, t || void 0));
}
//#endregion
...
function F(e, t, n) {
	L(e) || (n == null ? e.removeAttribute(t) : e.setAttribute(t, n));
}
function We(e, t, n, r) {
	L(e) || (r == null ? e.removeAttributeNS(t, n) : e.setAttributeNS(t, n, r));
}
function Ge(e, t, n) {
	L(e) || (n ? e.setAttribute(t, "") : e.removeAttribute(t));
}
function Ke(e, t) {
	L(e) || (t == null ? e.removeAttribute("class") : e.className = t);
}
function qe(e, t, n, r) {
...
function Je(e, t, n = {}) {
	...
	for (a = 0, o = i.length; a < o; a++) {
		let r = i[a];
		!r || r === "undefined" || t[r] || (tt(e, r, !1), delete n[r]);
	}
	for (a = 0, o = r.length; a < o; a++) {
		let i = r[a], o = !!t[i];
		!i || i === "undefined" || n[i] === o || !o || (tt(e, i, !0), n[i] = o);
	}
	return n;
}
function Ye(e, t, n) {
	if (!t) return n ? F(e, "style") : t;
	let r = e.style;
...
function Ze(e, t = {}, n, r) {
	let i = {};
	return r || w(() => i.children = R(e, t.children, i.children)), w(() => typeof t.ref == "function" && Qe(t.ref, e)), w(() => $e(e, t, n, !0, i, !0)), i;
}
function Qe(e, t, n) {
	return T(() => e(t, n));
}
function I(e, t, n, r) {
	if (n !== void 0 && !r && (r = []), typeof t != "function") return R(e, t, r, n);
	w((r) => R(e, t(), r, n), r);
}
function $e(e, t, n, r, i = {}, a = !1) {
	t ||= {};
	for (let r in i) if (!(r in t)) {
		if (r === "children") continue;
		i[r] = nt(e, r, null, i[r], n, a, t);
	}
	for (let o in t) {
		if (o === "children") {
			r || R(e, t.children);
...
function nt(e, t, n, r, i, a, o) {
	let s, c, l, u, d;
	if (t === "style") return Ye(e, n, r);
	if (t === "classList") return Je(e, n, r);
	if (n === r) return r;
	if (t === "ref") a || n(e);
		...
		(a || n) && (qe(e, i, n, a), a && Ue([i]));
	} else if (t.slice(0, 5) === "attr:") F(e, t.slice(5), n);
	else if (t.slice(0, 5) === "bool:") Ge(e, t.slice(5), n);
	else if ((d = t.slice(0, 5) === "prop:") || (l = Ne.has(t)) || !i && ((u = Ie(t, e.tagName)) || (c = Me.has(t))) || (s = e.nodeName.includes("-") || "is" in o)) {
		if (d) t = t.slice(5), c = !0;
		else if (L(e)) return n;
		t === "class" || t === "className" ? Ke(e, n) : s && !c && !l ? e[et(t)] = n : e[u || t] = n;
	} else {
		let r = i && t.indexOf(":") > -1 && Re[t.split(":")[0]];
		r ? We(e, r, t, n) : F(e, Pe[t] || t, n);
	}
	return n;
}
function rt(t) {
...
function R(e, t, n, r, i) {
	...
	if (e = s && n[0] && n[0].parentNode || e, o === "string" || o === "number") {
		...
		if (s) {
			let i = n[0];
			i && i.nodeType === 3 ? i.data !== t && (i.data = t) : i = document.createTextNode(t), n = z(e, n, r, i);
		...
		if (it(o, t, n, i)) return w(() => n = R(e, o, n, r, !0)), () => n;
		if (a) {
		...
		} else c ? n.length === 0 ? at(e, o, r) : Be(e, n, o) : (n && z(e), at(e, o));
		n = o;
	} else if (t.nodeType) {
...
function it(e, t, n, r) {
	...
	for (let a = 0, o = t.length; a < o; a++) {
		...
		else if (Array.isArray(o)) i = it(e, o, s) || i;
		else if (c === "function") if (r) {
			for (; typeof o == "function";) o = o();
			i = it(e, Array.isArray(o) ? o : [o], Array.isArray(s) ? s : [s]) || i;
		} else e.push(o), i = !0;
		else {
			let t = String(o);
...
function _t(e) {
	...
	function _(e, a, o = 1, s) {
		...
		let u = gt(a.filterCutoff), p = Math.min(e / 261.63 * u, t.sampleRate / 2 - 100);
	...
	function y(e) {
		g(e);
		let n = gt(e.filterCutoff), r = Math.min(m / 261.63 * n, t.sampleRate / 2 - 100);
...
var V = st("wus-v01", import.meta.url);
function vt(e) {
	return 440 * 2 ** ((e - 69) / 12);
}
var yt = 6;
function bt() {
	let e = V?.audioContext ?? new AudioContext(), t = V?.audioOutputNode ?? e.destination, n = ft(e);
	n.outputNode.connect(t);
	let r = Array.from({ length: yt }, () => ({
		voice: _t(e),
		midiNote: -1,
		startTime: 0,
		state: "idle"
...
var xt = /* @__PURE__ */ P("<div class=\"flex-ha gap-2 w-full px-3\"><span class=\"text-xs text-neutral-400 shrink-0\"style=width:50px;text-align:left></span><input type=range class=\"synth-slider flex-1\"><span class=\"text-xs text-neutral-200 shrink-0 font-mono\"style=width:30px;text-align:right>"), St = (e) => {
	let t = () => `${((e.value - e.min) / (e.max - e.min) * 100).toFixed(1)}%`, n = () => e.formatValue ? e.formatValue(e.value) : e.value.toFixed(2);
	return (() => {
		var r = xt(), i = r.firstChild, a = i.nextSibling, o = a.nextSibling;
		return I(i, () => e.label), a.$$input = (t) => e.onChange(Number.parseFloat(t.currentTarget.value)), I(o, n), w((n) => {
			var r = e.min, i = e.max, o = e.step, s = t();
			return r !== n.e && F(a, "min", n.e = r), i !== n.t && F(a, "max", n.t = i), o !== n.a && F(a, "step", n.a = o), s !== n.o && Xe(a, "--slider-fill", n.o = s), n;
		}, {
			e: void 0,
			t: void 0,
			a: void 0,
...
function Tt(e) {
	let t = e[a];
	if (!t && (Object.defineProperty(e, a, { value: t = new Proxy(e, kt) }), !Array.isArray(e))) {
...
var kt = {
	get(e, t, n) {
		if (t === Ct) return e;
		if (t === a) return n;
		if (t === s) return Dt(e), n;
		let r = K(e, H), i = r[t], o = i ? i() : e[t];
		if (t === H || t === U || t === "__proto__") return o;
		if (!i) {
			let n = Object.getOwnPropertyDescriptor(e, t);
			ae() && (typeof o != "function" || e.hasOwnProperty(t)) && !(n && n.get) && (o = q(r, t, o)());
		}
		return W(o) ? Tt(o) : o;
	},
	has(e, t) {
		return t === Ct || t === a || t === s || t === H || t === U || t === "__proto__" ? !0 : (ae() && q(K(e, U), t)(), t in e);
	},
	set() {
		return !0;
	},
...
function Y(e, t, n = []) {
	...
	let a = t[0];
	typeof a == "function" && (a = a(i, n), a === i) || r === void 0 && a == null || (a = G(a), r === void 0 || W(i) && W(a) && !Array.isArray(a) ? At(i, a) : J(e, r, a));
}
function Nt(...[e, t]) {
	let n = G(e || {}), r = Array.isArray(n), i = Tt(n);
	function a(...e) {
		ne(() => {
			r && e.length === 1 ? Mt(n, e[0]) : Y(n, e);
		});
	}
	return [i, a];
}
...
function Pt() {
	return Q || (Q = bt(), Q.updateParams(X.parameters)), Q;
}
var $ = {
	setParameter(e, t) {
		Z("parameters", (n) => ({
	...
	prevPreset() {
		let e = (X.currentPresetIndex - 1 + B.length) % B.length;
		$.selectPreset(e);
	},
	nextPreset() {
		let e = (X.currentPresetIndex + 1) % B.length;
		$.selectPreset(e);
	},
	noteOn(e, t, n) {
		Pt().noteOn(e, t, n);
...
}, Ft = /* @__PURE__ */ P("<div class=\"flex-v flex-1 justify-around py-2\">"), It = [
	{
		label: "Wave",
		key: "oscWave",
		min: 0,
		max: 3,
		step: 1,
		formatValue: (e) => pt[Math.round(e)] ?? "Saw"
	},
	{
		label: "Detune",
		key: "oscDetune",
...
})(), zt = /* @__PURE__ */ P("<div class=\"flex-h flex-1 overflow-hidden\"><div class=\"flex-v flex-1 border-r border-neutral-700\"></div><div class=\"flex-v flex-1\">"), Bt = () => (() => {
	var e = zt(), t = e.firstChild, n = t.nextSibling;
	return I(t, j(Rt, { params: It })), I(n, j(Rt, { params: Lt })), e;
})(), Vt = /* @__PURE__ */ P("<svg>");
function Ht(e, t) {
	return (() => {
		var n = Vt();
		return Ze(n, Ae(() => e.a, t, {
			get color() {
			...
			get innerHTML() {
				return ze(() => !!t.title)() ? `${e.c}<title>${t.title}</title>` : e.c;
			},
			src: void 0
		}), !0, !1), n;
	})();
...
var Gt = {
	Left: Ut,
	Right: Wt
}, Kt = /* @__PURE__ */ P("<div class=\"flex-ha justify-center gap-2 h-full px-3 py-2\"><button type=button class=\"flex-c text-cyan-400 hover:text-cyan-200 px-4 py-2 border border-neutral-700 cursor-pointer\"></button><div class=flex-c style=min-width:180px><select class=\"synth-select w-full h-[40px]\"></select></div><button type=button class=\"flex-c text-cyan-400 hover:text-cyan-200 px-4 py-2 border border-neutral-700 cursor-pointer\">"), qt = /* @__PURE__ */ P("<option>"), Jt = () => {
	let e = (e) => {
		let t = parseInt(e.target.value, 10);
		$.selectPreset(t);
	};
	return (() => {
		var t = Kt(), n = t.firstChild, r = n.nextSibling, i = r.firstChild, a = r.nextSibling;
		return n.$$click = () => $.prevPreset(), I(n, j(Gt.Left, { size: 20 })), i.addEventListener("change", e), I(i, () => B.map((e, t) => (() => {
			var n = qt();
			return I(n, e), w(() => n.value = String(t)), n;
		})())), a.$$click = () => $.nextPreset(), I(a, j(Gt.Right, { size: 20 })), w(() => i.value = String(X.currentPresetIndex)), t;
	})();
};
Ue(["click"]);
//#endregion
//#region src/sections/top-section.tsx
var Yt = /* @__PURE__ */ P("<div class=\"flex-ha w-full shrink-0 bg-neutral-800 border-b border-neutral-700\"style=height:54px><div class=\"flex-c shrink-0 border-r border-neutral-700 h-full px-4 w-[140px]\"><span class=\"text-cyan-400 uppercase font-bold\"style=font-size:0.7rem;letter-spacing:0.2em>Mini-Synth</span></div><div class=\"flex-1 flex-c h-full\"></div><div class=w-[140px]>"), Xt = () => (() => {
	var e = Yt(), t = e.firstChild;
	t.firstChild;
	var n = t.nextSibling;
	return I(n, j(Jt, {})), e;
})();
...
var $t = {
	...
	emitStateBytes() {
		let { currentPresetIndex: e, parameters: t } = X, n = $t.serializeParameters(t);
	...
	applyStateBytes(e) {
		if (e.length === 14 && e[0] === en) {
			let t = e[1], n = $t.deserializeParameters([...e.slice(2)]);
			$.loadState({
...
//#endregion
//#region src/app.tsx
var on = /* @__PURE__ */ P("<div class=\"flex-v bg-neutral-900 text-white overflow-hidden\"style=width:640px;height:320px>");
function sn() {
	return re(() => {
		V ? V.completeSetup({
			unitAspects: {
