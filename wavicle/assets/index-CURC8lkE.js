...
`,nt=`Roboto`,rt=`'Noto Sans JP'`,it=`'M PLUS 1p'`,at=`Orbitron, sans-serif`,ot=`Oxanium, sans-serif`,st=`${it}, sans-serif`,ct=`Play, sans-serif`,lt=`Play`;function ut(e,t){let{languageKey:n}=U();return n===`ja`?t:e}function dt(e,t){let{languageKey:n}=U();return n===`ja`?t:e}var ft={en:{instrument:`instrument`,volume:`volume`,release:`release`,midiIn:`MIDI IN`,none:`none`,msgNeedTapSomewhereToEnableAudioOutput:`Click somewhere to enable audio output.`},ja:{instrument:`音色`,volume:`音量`,release:`余韻`,midiIn:`MIDI IN`,none:`なし`,msgNeedTapSomewhereToEnableAudioOutput:`画面のどこかをクリックすると、オーディオ出力が有効になります。`}};function K(){let{languageKey:e}=Q.uiPresenter.state;return ft[e]}var q;(function(e){let t=[0,.9,1,2.1,2,3,3.9,4,5,5,6.1,6];function n(e,n){let r=e/12>>0,i=e%12,a=t[i];return n&&(a=Math.round(a)),r*7+a}e.getKeyOffsetInUnits=n;function r(e,t){return Math.floor(t+e*12/7)}e.getNoteNumberFormKeyOffset=r;let i=[1,3,6,8,10];function a(e){let t=e%12;return i.includes(t)}e.checkBlackKey=a;function o(e,t){let r=n(e,!0);return n(e+t,!0)-r}e.getKeysOuterWidthU=o})(q||={});function pt(e,t){if(!t)return;let n=e-t.rootNoteNumber;return t.labels[n]}var mt=({unitWidth:e,height:t,bottomNoteNumber:n,numKeys:r,holdNoteNumbers:i,onKeyHoldEvent:a,labelOptions:o,showCenterCMark:s,isMainKeys:c})=>{let l=`#f80b`,{getKeyOffsetInUnits:u,getKeysOuterWidthU:d,checkBlackKey:f}=q,p=je.range(n,n+r-1),m=u(n,!0),g=t*.63,_=e*.65,v=e*d(n,r)+1,y=h({playingNoteNumber:void 0}),b=e=>{a?.({noteNumber:e,hold:!0}),y.playingNoteNumber=e},x=()=>{y.playingNoteNumber&&=(a?.({noteNumber:y.playingNoteNumber,hold:!1}),void 0)},S=(e,t)=>{b(t),P(e,{moveHandler(e,t){let n=document.elementFromPoint(t.clientX,t.clientY);if(n?.classList.contains(`keyblocks-playable-key`)){let e=parseInt(n.dataset.noteNumber||``);isFinite(e)&&e!==y.playingNoteNumber&&(x(),b(e),N())}},upHandler(){x(),N()}})},C=!!a,w=e/10>>0,ee=`0 0 ${w}px ${w}px`,T=!!o;return M(E(`div`,null,p.map(t=>{let n=f(t),r=(u(t)-m)*e,a=i?.includes(t),c=pt(t,o),l=t===60&&s;return E(`div`,{key:t,class:[`key`,n&&`--black`,a&&`--hold`,C&&`--can-play`,C&&`keyblocks-playable-key`],style:{left:`${r}px`},onPointerDown:C&&(e=>S(e,t))||void 0,onTouchStart:Ee,"data-note-number":t},E(`div`,{if:l,class:`center-c-mark`}),E(`div`,{if:c,class:`label`},c))}),E(`div`,{class:`cover`,if:c})),j`
      position: relative;
      width: ${v}px;
      height: ${t}px;
    ...
    `)},ht=({unitWidthPx:e,heightPx:t,bottomNoteNumber:n,numKeys:r,activeRangeOffsetU:i,activeRangeSizeU:a,onScrollActiveRange:o})=>{let s=q.getKeysOuterWidthU(n,r),c=e*s,l=i*e,u=a*e;return M(E(`div`,null,E(`div`,{class:`inner`,onPointerDown:t=>{P(t,{moveHandler(t){o(F.clamp(i+t.x/e,0,s-a)),N()}})}})),j`
      position: relative;
      width: ${c}px;
      height: ${t}px;
      > .inner {
    ...
    `)},gt=({options:e,value:t,onChange:n,width:r,height:i,fontSize:a,disabled:o})=>{let s={...r?{width:`${r}px`}:{},...i?{height:`${i}px`}:{},...a?{fontSize:`${a}px`}:{}},c=U().colors.clControlHighlight;return M(E(`select`,{value:e.length>0?t:``,onChange:De(n),disabled:o,onKeyDown:e=>e.preventDefault(),style:s},e.map((e,t)=>{let n=typeof e==`string`?e:e.value,r=typeof e==`string`?e:e.label;return E(`option`,{value:n,key:t},r)})),j`
...
`,Y=({spec:e,size:t})=>{if(e.startsWith(`ri-`)||e.startsWith(`ph-`))return E(`i`,{class:[e,J(t)]});if(e.startsWith(`fa-`))return E(`i`,{class:[e,J(t&&t*.85>>0)]});if(e.startsWith(`ti-`))return E(`i`,{class:[`ti`,e,J(t)]});if(e.startsWith(`bi-`))return E(`i`,{class:[`bi`,e,J(t&&t*.9>>0)]});if(e.startsWith(`mi `)){let n=e.replace(`mi `,``);return E(`i`,{class:[`material-icons`,J(t)]},n)}if(e.startsWith(`mso `)){let n=e.replace(`mso `,``);return E(`span`,{class:[`material-symbols-outlined`,J(t)]},n)}return E(`div`,null,`invalid iconSpec: `,e)},_t=({iconSpec:e,size:t,onClick:n,disabled:r})=>{let i=U().colors.clForeground;return M(E(`div`,{class:r&&`--disabled`,onClick:n},E(Y,{spec:e,size:t})),j`
    ...
    `),j`
  color: red;
`;var xt=({isLoading:e})=>M(E(Y,{spec:`ph-spinner`,size:24,class:e&&`--visible`}),j`
      @keyframes rotation1 {
        0% {
          transform: rotate(0);
        }
    ...
    `),X=({height:e,asr:t=1.25,children:n,onClick:r,disabled:i})=>{let{colors:a}=U(),o=a.clControlHighlight,s=e*t>>0;return M(E(`div`,null,E(`div`,{onClick:r,class:[`inner`,i&&`--disabled`]},n)),j`
      width: ${s}px;
      height: ${e}px;
    ...
    `)},St=({value:e,onChange:t,size:n})=>{let r=U().colors.clControlHighlight,i=`rotate(${F.lerpMap(e,0,1,125,415)})`,a=h({dragging:!1});return M(E(`div`,null,E(`div`,{class:`cover`}),E(`svg`,{viewBox:`-50 -50 100 100`,class:a.dragging&&`--dragging`},E(`circle`,{class:`knob`,cx:0,cy:0,r:49,onPointerDown:n=>{let r=e;a.dragging=!0,P(n,{moveHandler(e){t(F.clamp(r-e.y*.01,0,1)),N()},upHandler(){a.dragging=!1,N()}})}}),E(`circle`,{class:`knob_inner`,cx:0,cy:0,r:40}),E(`g`,{class:`marker`,transform:i},E(`line`,{x1:12.5,y1:0,x2:45,y2:0})))),j`
...
`;var wt=({contentWidth:e,contentHeight:t,children:n})=>{let r=h({scale:1,mh:0,mv:0}),i=_(),a=i.current;if(a){let{clientWidth:n,clientHeight:i}=a;r.scale=Math.min(n/e,i/t),r.mh=Math.max((n-e*r.scale)/2,0),r.mv=Math.max((i-t*r.scale)/2,0)}else N();return g(N,[e,t]),M(E(`div`,{ref:i},E(`div`,{class:[`inner`,`bg-plane`],style:{width:`${e*r.scale}px`,height:`${t*r.scale}px`,marginLeft:`${r.mh}px`,marginTop:`${r.mv}px`}}),E(`div`,{class:`inner`,style:{width:`${e}px`,height:`${t}px`,transform:`scale(${r.scale}, ${r.scale})`,marginLeft:`${r.mh}px`,marginTop:`${r.mv}px`}},n)),j`
    ...
    `)},Tt=({size:e})=>{let t=U().colors.clForeground;return M(E(`div`,null,E(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 30 30`,version:`1.1`,xmlns:`http://www.w3.org/2000/svg`,style:`fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;`},E(`g`,{transform:`matrix(1,0,0,1,-410.457,-257.386)`},E(`path`,{d:`M411.064,276.322C412.981,274.63 414.799,273.823 416.523,273.682C419.474,273.442 422.05,275.124 424.166,277.126C426.668,279.492 429.351,281.214 432.286,281.515C433.825,281.673 435.453,281.456 437.179,280.708C434.503,284.436 430.132,286.866 425.197,286.866C418.519,286.866 412.873,282.416 411.064,276.322ZM410.91,268.489C412.884,266.703 414.753,265.856 416.523,265.711C419.474,265.471 422.05,267.154 424.166,269.155C426.668,271.521 429.351,273.243 432.286,273.544C434.613,273.783 437.145,273.165 439.905,271.152C439.926,271.474 439.937,271.799 439.937,272.126C439.937,273.307 439.798,274.456 439.535,275.557C436.964,277.886 434.704,278.747 432.592,278.531C430.27,278.293 428.208,276.819 426.228,274.946C423.496,272.363 420.088,270.382 416.28,270.692C414.447,270.842 412.499,271.514 410.48,272.956C410.464,272.682 410.457,272.405 410.457,272.126C410.457,270.872 410.614,269.653 410.91,268.489ZM413.299,263.427C415.983,259.765 420.314,257.386 425.197,257.386C431.828,257.386 437.442,261.774 439.292,267.803C436.821,269.969 434.637,270.769 432.592,270.56C430.27,270.322 428.208,268.848 426.228,266.975C423.496,264.392 420.088,262.411 416.28,262.721C415.316,262.8 414.32,263.023 413.299,263.427Z`})))),j`
      width: ${e}px;
      height: ${e}px;
      fill: ${t};
    `)},Et=({canGoPrev:e,canGoNext:t,onShift:n})=>M(E(`div`,null,E(X,{height:30,onClick:()=>n(-1),disabled:!e},E(Y,{spec:`ph-caret-left-fill`,size:20})),E(X,{height:30,onClick:()=>n(1),disabled:!t},E(Y,{spec:`ph-caret-right-fill`,size:20}))),j`
      display: flex;
      gap: 6px;
    `),Dt=({canGoPrev:e,canGoNext:t,onShift:n})=>{let r=80/45;return M(E(`div`,null,E(X,{height:45,onClick:()=>n(-1),disabled:!e,asr:r},E(Y,{spec:`ph-caret-left-fill`,size:32})),E(X,{height:45,onClick:()=>n(1),disabled:!t,asr:r},E(Y,{spec:`ph-caret-right-fill`,size:32}))),j`
      display: flex;
      gap: 12px;
    `)};function Ot(e){return F.lerpMap(e,-80,-3,0,1,!0)}function kt(e,t){for(let n=t.length-1;n>=0;n--){let r=t[n];if(r<e)return r}}function At(e,t){return t.find(t=>t>e)}function jt(e){let t=I.octaveSelectionKeyUnitOffsets,n,r={keyRangeOffset:I.activeKeyRangeUnitOffsetDefault,keysRangeSize:I.activeKeyRangeUnitSize,languageKey:L.isJapaneseEnvironment?`ja`:`en`,isCompactMode:localStorage.getItem(`wavicle_is_compact_mode`)===`1`,usagePanelVisible:!1,outputLevel01:0},i={get currentInstrumentIndex(){let{allInstrumentKeys:t,currentInstrumentKey:n}=e;return t.indexOf(n)},get canShiftInstrumentPrev(){return i.currentInstrumentIndex>0},get canShiftInstrumentNext(){let{allInstrumentKeys:t}=e;return i.currentInstrumentIndex<t.length-1},get canShiftKeysOffsetLower(){return r.keyRangeOffset>t[0]},get canShiftKeysOffsetHigher(){return r.keyRangeOffset<t[t.length-1]},get pcKeyboardRootNoteNumber(){let e=kt(r.keyRangeOffset+3.5,t)||0;return q.getNoteNumberFormKeyOffset(e,I.bottomNoteNumber)},get needUserActionForAudioOutput(){return!e.webAudioInitialized&&e.noteReceived}},a,o={initialize(){n=setInterval(()=>{let t=Ot(e.readOutputLevelDb());Math.abs(r.outputLevel01-t)<.01||(r.outputLevel01=t,N())},50)},finalize(){n&&=(clearInterval(n),void 0)},setKeyRangeOffset(e){r.keyRangeOffset=e},shiftInstrument(t){let n=i.currentInstrumentIndex;if(n>=0){let{allInstrumentKeys:r}=e,i=r[n+t];i&&e.setInstrument(i,!0)}},shiftOctave(e){a?.flush();let n=r.keyRangeOffset,i=(e===1?At:kt)(n,t);i!==void 0&&(a=Me(o.setKeyRangeOffset,n,i,500))},setLanguageKey(e){L.isJapaneseEnvironment&&(r.languageKey=e)},setCompactMode(e){r.isCompactMode=e,localStorage.setItem(`wavicle_is_compact_mode`,e?`1`:`0`)},showUsagePanel(){r.usagePanelVisible=!0},hideUsagePanel(){r.usagePanelVisible=!1}};return{state:r,readers:i,actions:o}}function Mt(){let e=Qe(),t=Ie(e),n=jt(e);return{synthEngine:e,midiInputDriver:t,uiPresenter:n,async initialize(){e.initialize(),n.actions.initialize(),e.setInstrument(e.currentInstrumentKey,!1),await t.initialize()}}}var Q=Mt();function Nt(){let e=`wavicle__app_persist_state`;return{load(){let t=localStorage.getItem(e);if(t)try{let{midiInDeviceId:e,currentInstrumentKey:n,instrumentParameters:r,languageKey:i,keyRangeOffset:a}=JSON.parse(t),{synthEngine:o,midiInputDriver:s,uiPresenter:c}=Q;s.allDeviceEntries.some(t=>t.id===e)&&s.selectDevice(e),o.allInstrumentKeys.includes(n)&&o.setInstrument(n,!1);let{volume:l,release:u}=r;F.between(l,0,1)&&F.between(u,0,1)&&(o.setInstrumentParameter(`volume`,l),o.setInstrumentParameter(`release`,u)),(i===`en`||i===`ja`)&&c.actions.setLanguageKey(i);let d=I.octaveSelectionKeyUnitOffsets[0],f=I.octaveSelectionKeyUnitOffsets[I.octaveSelectionKeyUnitOffsets.length-1];F.between(a,d,f)&&c.actions.setKeyRangeOffset(a)}catch{console.log(`failed to load persist state`)}},save(){let{synthEngine:t,midiInputDriver:n,uiPresenter:r}=Q,i=n.currentDeviceId,{currentInstrumentKey:a,instrumentParameters:o}=t,{state:{languageKey:s,keyRangeOffset:c}}=r,l={midiInDeviceId:i,currentInstrumentKey:a,instrumentParameters:o,languageKey:s,keyRangeOffset:c};localStorage.setItem(e,JSON.stringify(l))}}}var Pt=Nt();function Ft(){let e=Q.synthEngine;R?.completeSetup({unitAspects:{unitType:`instrument`,categoryHint:`synthesizer`,viewSize:[700,394]},noteInput:{noteOn(t){e.noteOn(t),N()},noteOff(t){e.noteOff(t),N()}},persistence:{emitState(){let{currentInstrumentKey:t,instrumentParameters:n}=e;return{currentInstrumentKey:t,instrumentParameters:n}},applyState(t){let{currentInstrumentKey:n,instrumentParameters:r}=t,{volume:i,release:a}=r;e.allInstrumentKeys.includes(n)&&e.setInstrument(n,!1),F.between(i,0,1)&&F.between(a,0,1)&&(e.setInstrumentParameter(`volume`,i),e.setInstrumentParameter(`release`,a)),Ce()}}})}var It=j`
  * {
    box-sizing: border-box;
    margin: 0;
    padding: 0;
...
`,Lt=20;function Rt(e){let t=e/19;return t<=.4?`hsl(84deg 100% 52%)`:t<=.9?`hsl(${F.lerpMap(t,.4,.9,84,0)}deg 100% 52%)`:`hsl(0deg 100% 52%)`}var zt=({level:e})=>{let t=Math.round(Math.max(0,Math.min(1,e))*Lt);return M(E(`div`,{class:`gauge`},Array.from({length:Lt},(e,n)=>{let r=n<t;return E(`div`,{class:r?`segment active`:`segment`,style:{background:r?Rt(n):void 0}})})),j`
      width: 150px;
      height: 28px;
      padding: 3px;
      display: flex;
    ...
    `)},Bt=()=>{let{state:{isCompactMode:e},actions:{setCompactMode:t}}=Q.uiPresenter;return M(E(`div`,null,E(_t,{iconSpec:e?`ph-arrows-out-simple`:`ph-arrows-in-simple`,size:45,onClick:()=>t(!e),class:e&&`--active`})),j`
    `)},Vt=()=>{let{allInstrumentKeys:e,currentInstrumentKey:t,setInstrument:n,isLoadingSamples:r}=Q.synthEngine,{state:{languageKey:i},readers:{canShiftInstrumentPrev:a,canShiftInstrumentNext:o},actions:{shiftInstrument:s}}=Q.uiPresenter,c=K(),l=e.map(e=>({value:e,label:Fe(e,i)}));return M(E(`div`,null,E(`div`,{class:`head-row`},E(Z,{text:c.instrument})),E(`div`,{class:`second-row`},E(gt,{options:l,value:t,onChange:e=>{n(e,!0)},width:130}),E(xt,{isLoading:r})),E(`div`,{class:`buttons-row`},E(Et,{canGoPrev:a,canGoNext:o,onShift:s}))),j`
      display: flex;
      flex-direction: column;
      > .head-row {
        display: flex;
    ...
    `)},Ht=()=>{let{readers:{canShiftInstrumentPrev:e,canShiftInstrumentNext:t},actions:{shiftInstrument:n}}=Q.uiPresenter;return E(Dt,{canGoPrev:e,canGoNext:t,onShift:n})},Ut=()=>{let{allInstrumentKeys:e,currentInstrumentKey:t,setInstrument:n,isLoadingSamples:r}=Q.synthEngine,{state:{languageKey:i}}=Q.uiPresenter,a=K(),o=e.map(e=>({value:e,label:Fe(e,i)}));return M(E(`div`,null,E(`div`,{class:`head-row`},E(Z,{text:a.instrument}),E(xt,{isLoading:r})),E(`div`,{class:`second-row`},E(gt,{options:o,value:t,onChange:e=>{n(e,!0)},width:172,height:44,fontSize:18})),E(`div`,{class:`buttons-row`})),j`
        > .head-row {
          display: flex;
        }
        > .second-row {
    ...
    `)},Wt=()=>{let{bottomNoteNumber:e,numKeys:t}=I,{holdNoteNumbers:n}=Q.synthEngine,{state:{keyRangeOffset:r,keysRangeSize:i},actions:{setKeyRangeOffset:a}}=Q.uiPresenter;return M(E(`div`,null,E(mt,{unitWidth:10,height:33,bottomNoteNumber:e,numKeys:t,holdNoteNumbers:n,showCenterCMark:!1,isMainKeys:!1}),E(`div`,{class:`cover`},E(ht,{unitWidthPx:10,heightPx:33,bottomNoteNumber:e,numKeys:t,activeRangeOffsetU:r,activeRangeSizeU:i,onScrollActiveRange:a}))),j`
      position: relative;
      > .cover {
        position: absolute;
        z-index: 1;
    ...
    `)},Gt=()=>{let{bottomNoteNumber:e,numKeys:t}=I,{holdNoteNumbers:n,noteOn:r,noteOff:i}=Q.synthEngine,{state:{keyRangeOffset:a,keysRangeSize:o}}=Q.uiPresenter,s=I.mainKeyUnitWidth;return M(E($e,{unitWidthPx:s,heightPx:254,activeRangeOffsetU:a,activeRangeSizeU:o},E(mt,{unitWidth:s,height:254,bottomNoteNumber:e,numKeys:t,holdNoteNumbers:n,onKeyHoldEvent:e=>{e.hold?r(e.noteNumber):i(e.noteNumber)},labelOptions:void 0,showCenterCMark:!1,isMainKeys:!0})),j`
      border-top: solid ${2}px #0004;
      border-left: solid ${3}px #0004;
      border-right: solid ${3}px #fff6;
      padding-bottom: 8px;
    `)},Kt=()=>{let{readers:{canShiftKeysOffsetLower:e,canShiftKeysOffsetHigher:t},actions:{shiftOctave:n}}=Q.uiPresenter;return E(Et,{canGoPrev:e,canGoNext:t,onShift:n})},qt=()=>{let{instrumentParameters:e,setInstrumentParameter:t}=Q.synthEngine,n=K();return M(E(`div`,null,E(`div`,null,E(Z,{text:n.volume}),E(St,{value:e.volume,onChange:e=>t(`volume`,e),size:50})),E(`div`,null,E(Z,{text:n.release}),E(St,{value:e.release,onChange:e=>t(`release`,e),size:50}))),j`
      display: flex;
      gap: 15px;
      > div {
        width: 70px;
    ...
    `)},Jt=()=>M(E(`div`,null,E(Tt,{size:44,class:`logo`}),E(`h1`,null,`Wavicle`)),j`
        display: flex;
        align-items: center;
        padding: 10px;
        gap: 1px;
    ...
    `)},Qt=()=>{let e=`#4ae`,{hideUsagePanel:t}=Q.uiPresenter.actions;return M(E(`div`,null,E(`div`,{class:`panel`},E(`div`,{class:`top-bar`},E(_t,{iconSpec:`ph-x-bold`,size:30,onClick:t})),E(`div`,{class:`content-body`},E(Zt,null)))),j`
      > .panel {
        background: #fff;
        color: #333;
        border: solid 3px ${e};
    ...
    `)},$t=()=>{let{colors:e}=U(),{outputLevel01:t}=Q.uiPresenter.state,n=e.clForeground,r=e.clPanelBody;return M(E(`div`,null,E(`div`,{class:`content`},E(`div`,{class:`top-row`},E(Jt,null),E(Bt,null)),E(`div`,{class:`main-row`},E(`div`,{class:`selectors-part`},E(Ut,null),E(Ht,{class:`shifter-buttons`})),E(`div`,{class:`controls-part-box`},E(qt,null),E(zt,{level:t})))),E(`div`,{class:`cover`})),j`
      position: relative;
      background: ${r};
      border-radius: 2px;
      width: 400px;
    ...
    `)},en=()=>{let{colors:e}=U(),{outputLevel01:t}=Q.uiPresenter.state,n=e.clForeground,r=e.clPanelBody;return M(E(`div`,null,E(`div`,{class:`top-row`},E(Vt,null),E(qt,null),E(`div`,{class:`top-right-part`},E(Bt,null)),E(Yt,null)),E(`div`,{class:`second-row`},E(`div`,{class:`keys-box`},E(Kt,null),E(Wt,null)),E(zt,{level:t})),E(`div`,{class:`main-keys-row`},E(Gt,null)),E(`div`,{class:`cover`})),j`
      position: relative;
      padding: 15px 15px 0;
      background: ${r};
      border-radius: 2px;
    ...
    `)},tn=()=>{let{languageKey:e,usagePanelVisible:t,isCompactMode:n}=Q.uiPresenter.state,r={...et,languageKey:e},i=ut(nt,rt);return M(E(tt.Provider,{value:r},E(`div`,null,n?E(wt,{contentWidth:400,contentHeight:225,class:`scaler-box`},E($t,null)):E(wt,{contentWidth:800,contentHeight:450,class:`scaler-box`},E(en,null)),E(Qt,{if:t}))),j`
      width: 100dvw;
      height: 100dvh;
      background: #aaa;
      display: flex;
    ...
    `)};async function nn(){console.log(`wavicle ${I.versionCode}`),await Q.initialize(),Pt.load(),xe(It),Te(()=>E(tn,null),document.getElementById(`app`)),Ft();let{activateWebAudioOnUserAction:e}=Q.synthEngine;window.addEventListener(`pointerdown`,e),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`hidden`&&Pt.save()}),window.addEventListener(`resize`,Ae(N,100)),window.addEventListener(`contextmenu`,Ee)}window.addEventListener(`load`,nn);