...
`,tt=`Roboto`,nt=`'Noto Sans JP'`,rt=`'M PLUS 1p'`,it=`Orbitron, sans-serif`,at=`Oxanium, sans-serif`,ot=`${rt}, sans-serif`,st=`Play, sans-serif`,ct=`Play`;function lt(e,t){let{languageKey:n}=U();return n===`ja`?t:e}function ut(e,t){let{languageKey:n}=U();return n===`ja`?t:e}var dt={en:{instrument:`instrument`,volume:`volume`,release:`release`,midiIn:`MIDI IN`,none:`none`,msgNeedTapSomewhereToEnableAudioOutput:`Click somewhere to enable audio output.`},ja:{instrument:`音色`,volume:`音量`,release:`余韻`,midiIn:`MIDI IN`,none:`なし`,msgNeedTapSomewhereToEnableAudioOutput:`画面のどこかをクリックすると、オーディオ出力が有効になります。`}};function K(){let{languageKey:e}=Q.uiPresenter.state;return dt[e]}var q;(function(e){let t=.1,n=[0,1-t,1,2+t,2,3,4-t,4,5,5,6+t,6];function r(e,t){let r=e/12>>0,i=n[e%12];return t&&(i=Math.round(i)),r*7+i}e.getKeyOffsetInUnits=r;function i(e,t){return Math.floor(t+e*12/7)}e.getNoteNumberFormKeyOffset=i;let a=[1,3,6,8,10];function o(e){let t=e%12;return a.includes(t)}e.checkBlackKey=o;function s(e,t){let n=r(e,!0);return r(e+t,!0)-n}e.getKeysOuterWidthU=s})(q||={});function ft(e,t){if(!t)return;let n=e-t.rootNoteNumber;return t.labels[n]}var pt=({unitWidth:e,height:t,bottomNoteNumber:n,numKeys:r,holdNoteNumbers:i,onKeyHoldEvent:a,labelOptions:o,showCenterCMark:s,isMainKeys:c})=>{let l=`#f80b`,{getKeyOffsetInUnits:u,getKeysOuterWidthU:d,checkBlackKey:f}=q,p=R.range(n,n+r-1),m=u(n,!0),g=t*.63,_=e*.65,v=e*d(n,r)+1,y=h({playingNoteNumber:void 0}),b=e=>{a?.({noteNumber:e,hold:!0}),y.playingNoteNumber=e},x=()=>{y.playingNoteNumber&&(a?.({noteNumber:y.playingNoteNumber,hold:!1}),y.playingNoteNumber)},ee=(e,t)=>{b(t),I(e,{moveHandler(e,t){let n=document.elementFromPoint(t.clientX,t.clientY);if(n?.classList.contains(`keyblocks-playable-key`)){let e=parseInt(n.dataset.noteNumber||``);isFinite(e)&&e!==y.playingNoteNumber&&(x(),b(e),N())}},upHandler(){x(),N()}})},S=!!a,C=e/10>>0,te=`0 0 ${C}px ${C}px`,w=!!o;return M(T(`div`,null,p.map(t=>{let n=f(t),r=(u(t)-m)*e,a=i?.includes(t),c=ft(t,o),l=t===60&&s;return T(`div`,{key:t,class:[`key`,n&&`--black`,a&&`--hold`,S&&`--can-play`,S&&`keyblocks-playable-key`],style:{left:`${r}px`},onPointerDown:S&&(e=>ee(e,t))||void 0,onTouchStart:Oe,"data-note-number":t},T(`div`,{if:l,class:`center-c-mark`}),T(`div`,{if:c,class:`label`},c))}),T(`div`,{class:`cover`,if:c})),j`
    ...
    `)},mt=({unitWidthPx:e,heightPx:t,bottomNoteNumber:n,numKeys:r,activeRangeOffsetU:i,activeRangeSizeU:a,onScrollActiveRange:o})=>{let s=q.getKeysOuterWidthU(n,r),c=e*s,l=i*e,u=a*e;return M(T(`div`,null,T(`div`,{class:`inner`,onPointerDown:t=>{I(t,{moveHandler(t){o(L.clamp(i+t.x/e,0,s-a)),N()}})}})),j`
      position: relative;
      width: ${c}px;
      height: ${t}px;
      > .inner {
...
`,Y=({spec:e,size:t})=>{if(e.startsWith(`ri-`)||e.startsWith(`ph-`))return T(`i`,{class:[e,J(t)]});if(e.startsWith(`fa-`))return T(`i`,{class:[e,J(t&&t*.85>>0)]});if(e.startsWith(`ti-`))return T(`i`,{class:[`ti`,e,J(t)]});if(e.startsWith(`bi-`))return T(`i`,{class:[`bi`,e,J(t&&t*.9>>0)]});if(e.startsWith(`mi `)){let n=e.replace(`mi `,``);return T(`i`,{class:[`material-icons`,J(t)]},n)}if(e.startsWith(`mso `)){let n=e.replace(`mso `,``);return T(`span`,{class:[`material-symbols-outlined`,J(t)]},n)}return T(`div`,null,`invalid iconSpec: `,e)},gt=({iconSpec:e,size:t,onClick:n,disabled:r})=>{let i=U().colors.clForeground;return M(T(`div`,{class:r&&`--disabled`,onClick:n},T(Y,{spec:e,size:t})),j`
    ...
    `),j`
  color: red;
`;var bt=({isLoading:e})=>M(T(Y,{spec:`ph-spinner`,size:24,class:e&&`--visible`}),j`
      @keyframes rotation1 {
        0% {
          transform: rotate(0);
        }
...
`;var Ct=({contentWidth:e,contentHeight:t,children:n})=>{let r=h({scale:1,mh:0,mv:0}),i=_(),a=i.current;if(a){let{clientWidth:n,clientHeight:i}=a;r.scale=Math.min(n/e,i/t),r.mh=Math.max((n-e*r.scale)/2,0),r.mv=Math.max((i-t*r.scale)/2,0)}else N();return g(N,[e,t]),M(T(`div`,{ref:i},T(`div`,{class:[`inner`,`bg-plane`],style:{width:`${e*r.scale}px`,height:`${t*r.scale}px`,marginLeft:`${r.mh}px`,marginTop:`${r.mv}px`}}),T(`div`,{class:`inner`,style:{width:`${e}px`,height:`${t}px`,transform:`scale(${r.scale}, ${r.scale})`,marginLeft:`${r.mh}px`,marginTop:`${r.mv}px`}},n)),j`
    ...
    `)},wt=({size:e})=>{let t=U().colors.clForeground;return M(T(`div`,null,T(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 30 30`,version:`1.1`,xmlns:`http://www.w3.org/2000/svg`,style:`fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;`},T(`g`,{transform:`matrix(1,0,0,1,-410.457,-257.386)`},T(`path`,{d:`M411.064,276.322C412.981,274.63 414.799,273.823 416.523,273.682C419.474,273.442 422.05,275.124 424.166,277.126C426.668,279.492 429.351,281.214 432.286,281.515C433.825,281.673 435.453,281.456 437.179,280.708C434.503,284.436 430.132,286.866 425.197,286.866C418.519,286.866 412.873,282.416 411.064,276.322ZM410.91,268.489C412.884,266.703 414.753,265.856 416.523,265.711C419.474,265.471 422.05,267.154 424.166,269.155C426.668,271.521 429.351,273.243 432.286,273.544C434.613,273.783 437.145,273.165 439.905,271.152C439.926,271.474 439.937,271.799 439.937,272.126C439.937,273.307 439.798,274.456 439.535,275.557C436.964,277.886 434.704,278.747 432.592,278.531C430.27,278.293 428.208,276.819 426.228,274.946C423.496,272.363 420.088,270.382 416.28,270.692C414.447,270.842 412.499,271.514 410.48,272.956C410.464,272.682 410.457,272.405 410.457,272.126C410.457,270.872 410.614,269.653 410.91,268.489ZM413.299,263.427C415.983,259.765 420.314,257.386 425.197,257.386C431.828,257.386 437.442,261.774 439.292,267.803C436.821,269.969 434.637,270.769 432.592,270.56C430.27,270.322 428.208,268.848 426.228,266.975C423.496,264.392 420.088,262.411 416.28,262.721C415.316,262.8 414.32,263.023 413.299,263.427Z`})))),j`
      width: ${e}px;
      height: ${e}px;
      fill: ${t};
    `)},Tt=({canGoPrev:e,canGoNext:t,onShift:n})=>M(T(`div`,null,T(X,{height:30,onClick:()=>n(-1),disabled:!e},T(Y,{spec:`ph-caret-left-fill`,size:20})),T(X,{height:30,onClick:()=>n(1),disabled:!t},T(Y,{spec:`ph-caret-right-fill`,size:20}))),j`
      display: flex;
      gap: 6px;
    `),Et=({canGoPrev:e,canGoNext:t,onShift:n})=>{let r=80/45;return M(T(`div`,null,T(X,{height:45,onClick:()=>n(-1),disabled:!e,asr:r},T(Y,{spec:`ph-caret-left-fill`,size:32})),T(X,{height:45,onClick:()=>n(1),disabled:!t,asr:r},T(Y,{spec:`ph-caret-right-fill`,size:32}))),j`
      display: flex;
      gap: 12px;
    `)};function Dt(e){return L.lerpMap(e,-80,-3,0,1,!0)}function Ot(e,t){for(let n=t.length-1;n>=0;n--){let r=t[n];if(r<e)return r}}function kt(e,t){return t.find(t=>t>e)}function At(e){let t=P.octaveSelectionKeyUnitOffsets,n,r={keyRangeOffset:P.activeKeyRangeUnitOffsetDefault,keysRangeSize:P.activeKeyRangeUnitSize,languageKey:F.isJapaneseEnvironment?`ja`:`en`,isCompactMode:localStorage.getItem(`wavicle_is_compact_mode`)===`1`,usagePanelVisible:!1,outputLevel01:0},i={get currentInstrumentIndex(){let{allInstrumentKeys:t,currentInstrumentKey:n}=e;return t.indexOf(n)},get canShiftInstrumentPrev(){return i.currentInstrumentIndex>0},get canShiftInstrumentNext(){let{allInstrumentKeys:t}=e;return i.currentInstrumentIndex<t.length-1},get canShiftKeysOffsetLower(){return r.keyRangeOffset>t[0]},get canShiftKeysOffsetHigher(){return r.keyRangeOffset<t[t.length-1]},get pcKeyboardRootNoteNumber(){let e=Ot(r.keyRangeOffset+3.5,t)||0;return q.getNoteNumberFormKeyOffset(e,P.bottomNoteNumber)},get needUserActionForAudioOutput(){return!e.webAudioInitialized&&e.noteReceived}},a,o={initialize(){n=setInterval(()=>{let t=Dt(e.readOutputLevelDb());Math.abs(r.outputLevel01-t)<.01||(r.outputLevel01=t,N())},50)},finalize(){n&&=(clearInterval(n),void 0)},setKeyRangeOffset(e){r.keyRangeOffset=e},shiftInstrument(t){let n=i.currentInstrumentIndex;if(n>=0){let{allInstrumentKeys:r}=e,i=r[n+t];i&&e.setInstrument(i,!0)}},shiftOctave(e){a?.flush();let n=r.keyRangeOffset,i=(e===1?kt:Ot)(n,t);i!==void 0&&(a=Ne(o.setKeyRangeOffset,n,i,500))},setLanguageKey(e){F.isJapaneseEnvironment&&(r.languageKey=e)},setCompactMode(e){r.isCompactMode=e,localStorage.setItem(`wavicle_is_compact_mode`,e?`1`:`0`)},showUsagePanel(){r.usagePanelVisible=!0},hideUsagePanel(){r.usagePanelVisible=!1}};return{state:r,readers:i,actions:o}}function jt(){let e=Ze(),t=Ie(e),n=At(e);return{synthEngine:e,midiInputDriver:t,uiPresenter:n,async initialize(){e.initialize(),n.actions.initialize(),e.setInstrument(e.currentInstrumentKey,!1),await t.initialize(),Fe(e)}}}var Q=jt();function Mt(){let e=`wavicle__app_persist_state`;return{load(){let t=localStorage.getItem(e);if(t)try{let{midiInDeviceId:e,currentInstrumentKey:n,instrumentParameters:r,languageKey:i,keyRangeOffset:a}=JSON.parse(t),{synthEngine:o,midiInputDriver:s,uiPresenter:c}=Q;s.allDeviceEntries.some(t=>t.id===e)&&s.selectDevice(e),o.allInstrumentKeys.includes(n)&&o.setInstrument(n,!1);let{volume:l,release:u}=r;L.between(l,0,1)&&L.between(u,0,1)&&(o.setInstrumentParameter(`volume`,l),o.setInstrumentParameter(`release`,u)),(i===`en`||i===`ja`)&&c.actions.setLanguageKey(i);let d=P.octaveSelectionKeyUnitOffsets[0],f=P.octaveSelectionKeyUnitOffsets[P.octaveSelectionKeyUnitOffsets.length-1];L.between(a,d,f)&&c.actions.setKeyRangeOffset(a)}catch{console.log(`failed to load persist state`)}},save(){let{synthEngine:t,midiInputDriver:n,uiPresenter:r}=Q,i=n.currentDeviceId,{currentInstrumentKey:a,instrumentParameters:o}=t,{state:{languageKey:s,keyRangeOffset:c}}=r,l={midiInDeviceId:i,currentInstrumentKey:a,instrumentParameters:o,languageKey:s,keyRangeOffset:c};localStorage.setItem(e,JSON.stringify(l))}}}var Nt=Mt(),Pt=j`
  * {
    box-sizing: border-box;
    margin: 0;
    padding: 0;
...
`,Ft=20;function It(e){let t=e/(Ft-1);return t<=.4?`hsl(84deg 100% 52%)`:t<=.9?`hsl(${L.lerpMap(t,.4,.9,84,0)}deg 100% 52%)`:`hsl(0deg 100% 52%)`}var Lt=({level:e})=>{let t=Math.round(Math.max(0,Math.min(1,e))*Ft);return M(T(`div`,{class:`gauge`},Array.from({length:Ft},(e,n)=>{let r=n<t;return T(`div`,{class:r?`segment active`:`segment`,style:{background:r?It(n):void 0}})})),j`
      width: 150px;
      height: 28px;
      padding: 3px;
      display: flex;
    ...
    `)},Rt=()=>{let{state:{isCompactMode:e},actions:{setCompactMode:t}}=Q.uiPresenter;return M(T(`div`,null,T(gt,{iconSpec:e?`ph-arrows-out-simple`:`ph-arrows-in-simple`,size:45,onClick:()=>t(!e),class:e&&`--active`})),j`
    `)},zt=()=>{let{allInstrumentKeys:e,currentInstrumentKey:t,setInstrument:n,isLoadingSamples:r}=Q.synthEngine,{state:{languageKey:i},readers:{canShiftInstrumentPrev:a,canShiftInstrumentNext:o},actions:{shiftInstrument:s}}=Q.uiPresenter,c=K(),l=e.map(e=>({value:e,label:De(e,i)}));return M(T(`div`,null,T(`div`,{class:`head-row`},T(Z,{text:c.instrument})),T(`div`,{class:`second-row`},T(ht,{options:l,value:t,onChange:e=>{n(e,!0)},width:130}),T(bt,{isLoading:r})),T(`div`,{class:`buttons-row`},T(Tt,{canGoPrev:a,canGoNext:o,onShift:s}))),j`
      display: flex;
      flex-direction: column;
      > .head-row {
        display: flex;
    ...
    `)},Bt=()=>{let{readers:{canShiftInstrumentPrev:e,canShiftInstrumentNext:t},actions:{shiftInstrument:n}}=Q.uiPresenter;return T(Et,{canGoPrev:e,canGoNext:t,onShift:n})},Vt=()=>{let{allInstrumentKeys:e,currentInstrumentKey:t,setInstrument:n,isLoadingSamples:r}=Q.synthEngine,{state:{languageKey:i}}=Q.uiPresenter,a=K(),o=e.map(e=>({value:e,label:De(e,i)}));return M(T(`div`,null,T(`div`,{class:`head-row`},T(Z,{text:a.instrument}),T(bt,{isLoading:r})),T(`div`,{class:`second-row`},T(ht,{options:o,value:t,onChange:e=>{n(e,!0)},width:172,height:44,fontSize:18})),T(`div`,{class:`buttons-row`})),j`
        > .head-row {
          display: flex;
        }
        > .second-row {
    ...
    `)},Ht=()=>{let{bottomNoteNumber:e,numKeys:t}=P,{holdNoteNumbers:n}=Q.synthEngine,{state:{keyRangeOffset:r,keysRangeSize:i},actions:{setKeyRangeOffset:a}}=Q.uiPresenter;return M(T(`div`,null,T(pt,{unitWidth:10,height:33,bottomNoteNumber:e,numKeys:t,holdNoteNumbers:n,showCenterCMark:!1,isMainKeys:!1}),T(`div`,{class:`cover`},T(mt,{unitWidthPx:10,heightPx:33,bottomNoteNumber:e,numKeys:t,activeRangeOffsetU:r,activeRangeSizeU:i,onScrollActiveRange:a}))),j`
      position: relative;
      > .cover {
        position: absolute;
        z-index: 1;
    ...
    `)},Ut=()=>{let{bottomNoteNumber:e,numKeys:t}=P,{holdNoteNumbers:n,noteOn:r,noteOff:i}=Q.synthEngine,{state:{keyRangeOffset:a,keysRangeSize:o}}=Q.uiPresenter,s=P.mainKeyUnitWidth;return M(T(Qe,{unitWidthPx:s,heightPx:254,activeRangeOffsetU:a,activeRangeSizeU:o},T(pt,{unitWidth:s,height:254,bottomNoteNumber:e,numKeys:t,holdNoteNumbers:n,onKeyHoldEvent:e=>{e.hold?r(e.noteNumber):i(e.noteNumber)},labelOptions:void 0,showCenterCMark:!1,isMainKeys:!0})),j`
      border-top: solid ${2}px #0004;
      border-left: solid ${3}px #0004;
      border-right: solid ${3}px #fff6;
      padding-bottom: 8px;
    `)},Wt=()=>{let{readers:{canShiftKeysOffsetLower:e,canShiftKeysOffsetHigher:t},actions:{shiftOctave:n}}=Q.uiPresenter;return T(Tt,{canGoPrev:e,canGoNext:t,onShift:n})},Gt=()=>{let{instrumentParameters:e,setInstrumentParameter:t}=Q.synthEngine,n=K();return M(T(`div`,null,T(`div`,null,T(Z,{text:n.volume}),T(xt,{value:e.volume,onChange:e=>t(`volume`,e),size:50})),T(`div`,null,T(Z,{text:n.release}),T(xt,{value:e.release,onChange:e=>t(`release`,e),size:50}))),j`
      display: flex;
      gap: 15px;
      > div {
        width: 70px;
    ...
    `)},Kt=()=>M(T(`div`,null,T(wt,{size:44,class:`logo`}),T(`h1`,null,`Wavicle`)),j`
        display: flex;
        align-items: center;
        padding: 10px;
        gap: 1px;
    ...
    `)},Xt=()=>{let e=`#4ae`,{hideUsagePanel:t}=Q.uiPresenter.actions;return M(T(`div`,null,T(`div`,{class:`panel`},T(`div`,{class:`top-bar`},T(gt,{iconSpec:`ph-x-bold`,size:30,onClick:t})),T(`div`,{class:`content-body`},T(Yt,null)))),j`
      > .panel {
        background: #fff;
        color: #333;
        border: solid 3px ${e};
    ...
    `)},Zt=()=>{let{colors:e}=U(),{outputLevel01:t}=Q.uiPresenter.state,n=e.clForeground,r=e.clPanelBody;return M(T(`div`,null,T(`div`,{class:`content`},T(`div`,{class:`top-row`},T(Kt,null),T(Rt,null)),T(`div`,{class:`main-row`},T(`div`,{class:`selectors-part`},T(Vt,null),T(Bt,{class:`shifter-buttons`})),T(`div`,{class:`controls-part-box`},T(Gt,null),T(Lt,{level:t})))),T(`div`,{class:`cover`})),j`
      position: relative;
      background: ${r};
      border-radius: 2px;
      width: 400px;
    ...
    `)},Qt=()=>{let{colors:e}=U(),{outputLevel01:t}=Q.uiPresenter.state,n=e.clForeground,r=e.clPanelBody;return M(T(`div`,null,T(`div`,{class:`top-row`},T(zt,null),T(Gt,null),T(`div`,{class:`top-right-part`},T(Rt,null)),T(qt,null)),T(`div`,{class:`second-row`},T(`div`,{class:`keys-box`},T(Wt,null),T(Ht,null)),T(Lt,{level:t})),T(`div`,{class:`main-keys-row`},T(Ut,null)),T(`div`,{class:`cover`})),j`
      position: relative;
      padding: 15px 15px 0;
      background: ${r};
      border-radius: 2px;
    ...
    `)},$t=()=>{let{languageKey:e,usagePanelVisible:t,isCompactMode:n}=Q.uiPresenter.state,r={...$e,languageKey:e},i=lt(tt,nt);return M(T(et.Provider,{value:r},T(`div`,null,n?T(Ct,{contentWidth:400,contentHeight:225,class:`scaler-box`},T(Zt,null)):T(Ct,{contentWidth:800,contentHeight:450,class:`scaler-box`},T(Qt,null)),T(Xt,{if:t}))),j`
      width: 100dvw;
      height: 100dvh;
      background: #aaa;
      display: flex;
    ...
    `)};async function en(){console.log(`wavicle ${P.versionCode}`),await Q.initialize(),Nt.load(),xe(Pt),we(()=>T($t,null),document.getElementById(`app`));let{activateWebAudioOnUserAction:e}=Q.synthEngine;window.addEventListener(`pointerdown`,e),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`hidden`&&Nt.save()}),window.addEventListener(`resize`,Me(N,100)),window.addEventListener(`contextmenu`,Oe)}window.addEventListener(`load`,en);