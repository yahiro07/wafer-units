...
var i = (e, t) => e === t, a = Symbol("solid-proxy"), o = Symbol("solid-track"), s = { equals: i }, c = null, l = pe, u = 1, d = 2, f = {
	owned: null,
	cleanups: null,
	context: null,
	owner: null
...
function ie(e) {
	...
	return Promise.resolve().then(() => {
		...
		return (h || se) && (r = m ||= {
			...
			running: !0
		}, r.done ||= new Promise((e) => r.resolve = e), r.running = !0), E(e, !1), _ = p = null, r ? r.done : void 0;
	});
}
	...
	if (!e.comparator || !e.comparator(r, t)) {
		...
		e.observers && e.observers.length && E(() => {
			for (let t = 0; t < e.observers.length; t += 1) {
				...
				r && m.disposed.has(n) || ((r ? !n.tState : !n.state) && (n.pure ? v.push(n) : y.push(n), n.observers && he(n)), r ? n.tState = u : n.state = u);
			}
...
function w(e) {
	...
	O(e);
	let t = b;
	ue(e, m && m.running && m.sources.has(e) ? e.tValue : e.value, t), m && !m.running && m.sources.has(e) && queueMicrotask(() => {
		E(() => {
			m && (m.running = !0), _ = p = e, ue(e, e.tValue, t), _ = p = null;
		}, !1);
	});
}
function ue(e, t, n) {
...
function fe(e) {
	if (v &&= (h && m && m.running ? me(v) : pe(v), null), e) return;
	let t;
	if (m) {
...
function D(e, t) {
	...
	for (let r = 0; r < e.sources.length; r += 1) {
		...
		if (i.sources) {
			...
			e === u ? i !== t && (!i.updatedAt || i.updatedAt < b) && T(i) : e === d && D(i, t);
		}
	}
}
function he(e) {
	...
	for (let n = 0; n < e.observers.length; n += 1) {
		let r = e.observers[n];
		(t ? !r.tState : !r.state) && (t ? r.tState = d : r.state = d, r.pure ? v.push(r) : y.push(r), r.observers && he(r));
	}
}
function O(e) {
	let t;
...
function ge(e, t) {
	if (t || (e.tState = 0, m.disposed.add(e)), e.owned) for (let t = 0; t < e.owned.length; t++) ge(e.owned[t]);
}
function _e(e) {
...
function k(e, t = p) {
	let n = c && t && t.context && t.context[c], r = _e(e);
	if (!n) throw r;
	y ? y.push({
		fn() {
			ve(r, n, t);
...
function we(e, t = window.document) {
	let n = t[xe] || (t[xe] = /* @__PURE__ */ new Set());
	for (let r = 0, i = e.length; r < i; r++) {
		let i = e[r];
		n.has(i) || (n.add(i), t.addEventListener(i, Ee));
	}
}
function j(e, t, n) {
...
function P(e, t, n, r, i) {
	...
	if (e = s && n[0] && n[0].parentNode || e, o === "string" || o === "number") {
		...
		if (F(o, t, n, i)) return S(() => n = P(e, o, n, r, !0)), () => n;
		if (a) {
		...
		} else c ? n.length === 0 ? De(e, o, r) : be(e, n, o) : (n && I(e), De(e, o));
		n = o;
	} else if (t.nodeType) {
...
function F(e, t, n, r) {
	...
	for (let a = 0, o = t.length; a < o; a++) {
		...
		else if (Array.isArray(o)) i = F(e, o, s) || i;
		else if (c === "function") if (r) {
			for (; typeof o == "function";) o = o();
			i = F(e, Array.isArray(o) ? o : [o], Array.isArray(s) ? s : [s]) || i;
		} else e.push(o), i = !0;
		else {
			let t = String(o);
...
function Ne(e) {
	let t = e.createGain(), n = e.createGain(), r = ke(e), i = Me(e), a = je(e);
...
var Ie = "" + new URL("assets/worklet-_C0HFN8c.js", import.meta.url).href, R = Oe("wus-v01", import.meta.url), Le = (e) => 440 * 2 ** ((e - 69) / 12);
function Re() {
	let e = null, t = null, n, r = /* @__PURE__ */ new Map(), i = { ...L };
	async function a() {
		if (e) return;
		e = R?.audioContext || new (window.AudioContext || window.webkitAudioContext)();
		let r = R?.audioOutputNode ?? e.destination;
		await e.audioWorklet.addModule(Ie), t = e.createGain(), t.gain.setValueAtTime(i.master, e.currentTime), n = Ne(e), t.connect(n.inputNode), n.outputNode.connect(r);
	}
	function o(t, n) {
	...
	return {
		...
		noteOn(n, a) {
			...
			c && c.setValueAtTime(Le(n), s), Object.keys(i).forEach((e) => {
...
var z = Re(), ze = Symbol("store-raw"), B = Symbol("store-node"), V = Symbol("store-has"), Be = Symbol("store-self");
function Ve(e) {
	let t = e[a];
	if (!t && (Object.defineProperty(e, a, { value: t = new Proxy(e, Ge) }), !Array.isArray(e))) {
...
var Ge = {
	...
	has(e, t) {
		return t === ze || t === a || t === o || t === B || t === V || t === "__proto__" ? !0 : (re() && G(W(e, V), t)(), t in e);
	},
	set() {
		return !0;
	},
...
function q(e, t, n = []) {
	...
	if (t.length > 1) {
		...
		if (a === "string" && (r === "__proto__" || t.length > 1 && qe(r))) return;
		if (Array.isArray(r)) {
	...
	let a = t[0];
	typeof a == "function" && (a = a(i, n), a === i) || r === void 0 && a == null || (a = U(a), r === void 0 || H(i) && H(a) && !Array.isArray(a) ? Ke(i, a) : K(e, r, a));
}
function Ye(...[e, t]) {
	let n = U(e || {}), r = Array.isArray(n), i = Ve(n);
	function a(...e) {
		te(() => {
			r && e.length === 1 ? Je(n, e[0]) : q(n, e);
		});
	}
	return [i, a];
}
...
var X = {
	async noteOn(e, t = 0, n = 1) {
		z.noteOn(e, t), Y("numActiveNotes", z.getNumActiveNotes());
	},
	noteOff(e, t = 0) {
		z.noteOff(e, t), Y("numActiveNotes", z.getNumActiveNotes());
	},
	setSynthParam(e, t) {
		Y("synthParams", e, t), z.setParameter(e, t);
	},
	loadStates(e) {
		Y("synthParams", e.synthParams), z.setAllParameters(e.synthParams);
	}
};
//#endregion
...
var Xe = {
	...
	emitStateBytes() {
		let { synthParams: e } = J, t = Xe.serializeParameters(e);
		return new Uint8Array([Ze, ...t]);
	},
	applyStateBytes(e) {
		if (e.length === Qe && e[0] === Ze) {
			let t = Xe.deserializeParameters([...e.slice(1)]);
...
function rt() {
	R ? R.completeSetup({
		...
		async noteOn(e) {
			await z.resumeIfNeeded(), X.noteOn(e);
		},
		noteOff(e) {
			X.noteOff(e);
		}
...
//#endregion
//#region src/app.tsx
var it = /* @__PURE__ */ Ce("<div style=\"display:flex;align-items:center;justify-content:space-between;margin:8px 0;gap:16px\"><span style=width:84px;font-size:14px;font-weight:bold></span><input type=range min=0 class=accent-violet-400 style=flex:1;cursor:pointer><span style=width:24px;text-align:right;font-size:12px;color:#888>"), at = /* @__PURE__ */ Ce("<div class=\"w-[660px] h-[380px] flex-c bg-mist-700\"><div class=\"flex-h gap-4\"><div class=\"flex-v gap-4\"><div><h3>OSCILLATOR</h3></div><div><h3>AMP ENVELOPE</h3></div></div><div class=\"flex-v gap-4\"><div class=\"flex-v gap-4\"><div><h3>EFFECTS</h3></div></div><div><h3>CONTROL</h3></div><div class=\"w-full flex-ha mt-[-4px] text-xs font-bold justify-between\"><div>proto-engine-pd-fm</div><div>active notes: ");
function $(e) {
	let t = e.paramKey === "waveMode", n = t ? "3" : "1", r = t ? "1" : "0.01";
	return (() => {
		var i = it(), a = i.firstChild, o = a.nextSibling, s = o.nextSibling;
		return N(a, () => e.label), o.$$input = (t) => X.setSynthParam(e.paramKey, parseFloat(t.currentTarget.value)), j(o, "max", n), j(o, "step", r), N(s, () => t ? `M${J.synthParams[e.paramKey]}` : J.synthParams[e.paramKey].toFixed(2)), S(() => o.value = J.synthParams[e.paramKey]), i;
	})();
}
var ot = () => {
	let e = {
	...
	return (() => {
		var t = at(), n = t.firstChild.firstChild, r = n.firstChild, i = r.firstChild, a = r.nextSibling, o = a.firstChild, s = n.nextSibling.firstChild, c = s.firstChild, l = c.firstChild, u = s.nextSibling, d = u.firstChild, f = u.nextSibling.firstChild.nextSibling;
		return f.firstChild, N(r, A($, {
			paramKey: "waveMode",
			label: "Wave Mode"
		}), null), N(r, A($, {
			paramKey: "shape",
			...
			paramKey: "loFi",
			label: "Lo-Fi"
		}), null), N(f, () => J.numActiveNotes, null), S((n) => {
			...
			return n.e = M(t, s, n.e), n.t = M(r, f, n.t), n.a = M(i, p, n.a), n.o = M(a, m, n.o), n.i = M(o, h, n.i), n.n = M(c, g, n.n), n.s = M(l, _, n.s), n.h = M(u, v, n.h), n.r = M(d, y, n.r), n;
		}, {
			e: void 0,
			t: void 0,
			a: void 0,
...
var ct = "@import \"https://fonts.googleapis.com/css2?family=Oxanium:wght@400..700&display=swap\";@layer components;@layer properties{@supports (((-webkit-hyphens:none)) and (not (margin-trim:inline))) or ((-moz-orient:inline) and (not (color:rgb(from red r g b)))){*,:before,:after,::backdrop{--tw-rotate-x:initial;--tw-rotate-y:initial;--tw-rotate-z:initial;--tw-skew-x:initial;--tw-skew-y:initial;--tw-border-style:solid;--tw-font-weight:initial}}}@layer theme{:root,:host{--font-sans:ui-sans-serif, system-ui, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";--font-mono:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace;--color-violet-400:oklch(70.2% .183 293.541);--color-mist-700:oklch(37.8% .015 216);--spacing:.25rem;--text-xs:.75rem;--text-xs--line-height:calc(1 / .75);--font-weight-bold:700;--default-transition-duration:.15s;--default-transition-timing-function:cubic-bezier(.4, 0, .2, 1);--default-font-family:var(--font-sans);--default-mono-font-family:var(--font-mono)}}@layer base{*,:after,:before,::backdrop{box-sizing:border-box;border:0 solid;margin:0;padding:0}::file-selector-button{box-sizing:border-box;border:0 solid;margin:0;padding:0}html,:host{-webkit-text-size-adjust:100%;tab-size:4;line-height:1.5;font-family:var(--default-font-family,ui-sans-serif, system-ui, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\");font-feature-settings:var(--default-font-feature-settings,normal);font-variation-settings:var(--default-font-variation-settings,normal);-webkit-tap-highlight-color:transparent}hr{height:0;color:inherit;border-top-width:1px}abbr:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;-webkit-text-decoration:inherit;-webkit-text-decoration:inherit;-webkit-text-decoration:inherit;-webkit-text-decoration:inherit;text-decoration:inherit}b,strong{font-weight:bolder}code,kbd,samp,pre{font-family:var(--default-mono-font-family,ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace);font-feature-settings:var(--default-mono-font-feature-settings,normal);font-variation-settings:var(--default-mono-font-variation-settings,normal);font-size:1em}small{font-size:80%}sub,sup{vertical-align:baseline;font-size:75%;line-height:0;position:relative}sub{bottom:-.25em}sup{top:-.5em}table{text-indent:0;border-color:inherit;border-collapse:collapse}:-moz-focusring{outline:auto}progress{vertical-align:baseline}summary{display:list-item}ol,ul,menu{list-style:none}img,svg,video,canvas,audio,iframe,embed,object{vertical-align:middle;display:block}img,video{max-width:100%;height:auto}button,input,select,optgroup,textarea{font:inherit;font-feature-settings:inherit;font-variation-settings:inherit;letter-spacing:inherit;color:inherit;opacity:1;background-color:#0000;border-radius:0}::file-selector-button{font:inherit;font-feature-settings:inherit;font-variation-settings:inherit;letter-spacing:inherit;color:inherit;opacity:1;background-color:#0000;border-radius:0}:where(select:is([multiple],[size])) optgroup{font-weight:bolder}:where(select:is([multiple],[size])) optgroup option{padding-inline-start:20px}::file-selector-button{margin-inline-end:4px}::placeholder{opacity:1}@supports (not ((-webkit-appearance:-apple-pay-button))) or (contain-intrinsic-size:1px){::placeholder{color:currentColor}@supports (color:color-mix(in lab, red, red)){::placeholder{color:color-mix(in oklab, currentcolor 50%, transparent)}}}textarea{resize:vertical}::-webkit-search-decoration{-webkit-appearance:none}::-webkit-date-and-time-value{min-height:1lh;text-align:inherit}::-webkit-datetime-edit{display:inline-flex}::-webkit-datetime-edit-fields-wrapper{padding:0}::-webkit-datetime-edit{padding-block:0}::-webkit-datetime-edit-year-field{padding-block:0}::-webkit-datetime-edit-month-field{padding-block:0}::-webkit-datetime-edit-day-field{padding-block:0}::-webkit-datetime-edit-hour-field{padding-block:0}::-webkit-datetime-edit-minute-field{padding-block:0}::-webkit-datetime-edit-second-field{padding-block:0}::-webkit-datetime-edit-millisecond-field{padding-block:0}::-webkit-datetime-edit-meridiem-field{padding-block:0}::-webkit-calendar-picker-indicator{line-height:1}:-moz-ui-invalid{box-shadow:none}button,input:where([type=button],[type=reset],[type=submit]){appearance:button}::file-selector-button{appearance:button}::-webkit-inner-spin-button{height:auto}::-webkit-outer-spin-button{height:auto}[hidden]:where(:not([hidden=until-found])){display:none!important}*{box-sizing:border-box;margin:0;padding:0}}@layer utilities{.fixed{position:fixed}.static{position:static}.mt-\\[-4px\\]{margin-top:-4px}.flex{display:flex}.h-\\[380px\\]{height:380px}.w-\\[660px\\]{width:660px}.w-full{width:100%}.transform{transform:var(--tw-rotate-x,) var(--tw-rotate-y,) var(--tw-rotate-z,) var(--tw-skew-x,) var(--tw-skew-y,)}.justify-between{justify-content:space-between}.gap-4{gap:calc(var(--spacing) * 4)}.border{border-style:var(--tw-border-style);border-width:1px}.bg-mist-700{background-color:var(--color-mist-700)}.text-xs{font-size:var(--text-xs);line-height:var(--tw-leading,var(--text-xs--line-height))}.font-bold{--tw-font-weight:var(--font-weight-bold);font-weight:var(--font-weight-bold)}.accent-violet-400{accent-color:var(--color-violet-400)}.transition{transition-property:color,background-color,border-color,outline-color,text-decoration-color,fill,stroke,--tw-gradient-from,--tw-gradient-via,--tw-gradient-to,opacity,box-shadow,transform,translate,scale,rotate,filter,-webkit-backdrop-filter,backdrop-filter,display,content-visibility,overlay,pointer-events;transition-timing-function:var(--tw-ease,var(--default-transition-timing-function));transition-duration:var(--tw-duration,var(--default-transition-duration))}}body{-webkit-user-select:none;user-select:none;min-height:100dvh;font-family:Oxanium,sans-serif}@property --tw-rotate-x{syntax:\"*\";inherits:false}@property --tw-rotate-y{syntax:\"*\";inherits:false}@property --tw-rotate-z{syntax:\"*\";inherits:false}@property --tw-skew-x{syntax:\"*\";inherits:false}@property --tw-skew-y{syntax:\"*\";inherits:false}@property --tw-border-style{syntax:\"*\";inherits:false;initial-value:solid}@property --tw-font-weight{syntax:\"*\";inherits:false}", lt = ".flex-h{display:flex}.flex-hs{align-items:start;display:flex}.flex-ha{align-items:center;display:flex}.flex-v{flex-direction:column;display:flex}.flex-vl{flex-direction:column;align-items:flex-start;display:flex}.flex-va{flex-direction:column;align-items:center;display:flex}.flex-c{justify-content:center;align-items:center;display:flex}.flex-vc{flex-direction:column;justify-content:center;align-items:center;display:flex}.bd-red{border:1px solid red}.bd-blue{border:1px solid #00f}", ut = class extends HTMLElement {
	...
	connectedCallback() {
		...
		e.dataset.unit1Styles = "true", e.textContent = ct + lt, this.shadowRoot.appendChild(e), this.disposeRender = Se(() => A(st, {}), this.shadowRoot), this.isMounted = !0;
	}
